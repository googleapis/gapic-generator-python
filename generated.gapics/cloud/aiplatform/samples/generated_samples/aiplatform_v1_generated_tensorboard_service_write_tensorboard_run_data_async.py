...
async def sample_write_tensorboard_run_data():
    ...
    time_series_data.values.scalar.value = 0.541
    time_series_data.values.tensor.value = b'value_blob'
    time_series_data.values.tensor.version_number = 1518
    time_series_data.values.blobs.values.id = "id_value"
    time_series_data.values.blobs.values.data = b'data_blob'
    time_series_data.values.wall_time.seconds = 751
    time_series_data.values.wall_time.nanos = 543
    time_series_data.values.step = 444
