...
def sample_create_metadata_schema():
    ...
    metadata_schema.name = "name_value"
    metadata_schema.schema_version = "schema_version_value"
    metadata_schema.schema = "schema_value"
    metadata_schema.schema_type = "CONTEXT_TYPE"
    metadata_schema.create_time.seconds = 751
    metadata_schema.create_time.nanos = 543
    metadata_schema.description = "description_value"
