...
def sample_batch_migrate_resources():
    ...
    migrate_resource_requests.migrate_automl_model_config.model = "model_value"
    migrate_resource_requests.migrate_automl_model_config.model_display_name = "model_display_name_value"
    migrate_resource_requests.migrate_automl_dataset_config.dataset = "dataset_value"
    migrate_resource_requests.migrate_automl_dataset_config.dataset_display_name = "dataset_display_name_value"
    migrate_resource_requests.migrate_data_labeling_dataset_config.dataset = "dataset_value"
    migrate_resource_requests.migrate_data_labeling_dataset_config.dataset_display_name = "dataset_display_name_value"
    migrate_resource_requests.migrate_data_labeling_dataset_config.migrate_data_labeling_annotated_dataset_configs.annotated_dataset = "annotated_dataset_value"
