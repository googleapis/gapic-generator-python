...
def sample_import_feature_values():
    ...
    csv_source = aiplatform_v1.CsvSource()
    csv_source.gcs_source.uris = ['uris_value1', 'uris_value2']

    feature_time = aiplatform_v1.Timestamp()
    feature_time.seconds = 751
    feature_time.nanos = 543

    feature_specs = aiplatform_v1.FeatureSpec()
    feature_specs.id = "id_value"
    feature_specs.source_field = "source_field_value"
