...
async def sample_search_model_deployment_monitoring_stats_anomalies():
    ...
    objectives = aiplatform_v1.StatsAnomaliesObjective()
    objectives.type_ = "FEATURE_ATTRIBUTION_DRIFT"
    objectives.top_feature_count = 1830

    start_time = aiplatform_v1.Timestamp()
    start_time.seconds = 751
    start_time.nanos = 543

    end_time = aiplatform_v1.Timestamp()
    end_time.seconds = 751
    end_time.nanos = 543
