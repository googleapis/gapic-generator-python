...
def sample_write_tensorboard_experiment_data():
    ...
    write_run_data_requests.time_series_data.values.scalar.value = 0.541
    write_run_data_requests.time_series_data.values.tensor.value = b'value_blob'
    write_run_data_requests.time_series_data.values.tensor.version_number = 1518
    write_run_data_requests.time_series_data.values.blobs.values.id = "id_value"
    write_run_data_requests.time_series_data.values.blobs.values.data = b'data_blob'
    write_run_data_requests.time_series_data.values.wall_time.seconds = 751
    write_run_data_requests.time_series_data.values.wall_time.nanos = 543
    write_run_data_requests.time_series_data.values.step = 444
