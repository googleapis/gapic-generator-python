...
async def sample_batch_create_tensorboard_runs():
    ...
    requests.tensorboard_run.name = "name_value"
    requests.tensorboard_run.display_name = "display_name_value"
    requests.tensorboard_run.description = "description_value"
    requests.tensorboard_run.create_time.seconds = 751
    requests.tensorboard_run.create_time.nanos = 543
    requests.tensorboard_run.update_time.seconds = 751
    requests.tensorboard_run.update_time.nanos = 543
    requests.tensorboard_run.labels.key = "key_value"
    requests.tensorboard_run.labels.value = "value_value"
    requests.tensorboard_run.etag = "etag_value"
