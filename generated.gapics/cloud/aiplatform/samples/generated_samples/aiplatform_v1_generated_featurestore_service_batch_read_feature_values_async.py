...
async def sample_batch_read_feature_values():
    ...
    bigquery_read_instances = aiplatform_v1.BigQuerySource()
    bigquery_read_instances.input_uri = "input_uri_value"
    ...
    pass_through_fields = aiplatform_v1.PassThroughField()
    pass_through_fields.field_name = "field_name_value"
    ...
    entity_type_specs.settings.feature_id = "feature_id_value"
    entity_type_specs.settings.destination_field = "destination_field_value"

    start_time = aiplatform_v1.Timestamp()
    start_time.seconds = 751
    start_time.nanos = 543
