...
def sample_raw_predict():
    ...
    http_body = aiplatform_v1.HttpBody()
    http_body.content_type = "content_type_value"
    http_body.data = b'data_blob'
    http_body.extensions.type_url = "type.googleapis.com/google.protobuf.Empty"
    http_body.extensions.value = b'value_blob'
