...
def sample_add_trial_measurement():
    ...
    measurement = aiplatform_v1.Measurement()
    measurement.elapsed_duration.seconds = 751
    measurement.elapsed_duration.nanos = 543
    measurement.step_count = 1092
    measurement.metrics.metric_id = "metric_id_value"
    measurement.metrics.value = 0.541
