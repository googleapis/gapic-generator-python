...
async def sample_create_tensorboard_run():
    ...
    tensorboard_run.description = "description_value"
    tensorboard_run.create_time.seconds = 751
    tensorboard_run.create_time.nanos = 543
    tensorboard_run.update_time.seconds = 751
    tensorboard_run.update_time.nanos = 543
    tensorboard_run.labels.key = "key_value"
    tensorboard_run.labels.value = "value_value"
    tensorboard_run.etag = "etag_value"
