...
def test_create_room(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
        ...
        call.return_value = messaging_pb2.Room(
            name='name_value',
    ...
    assert isinstance(response, messaging_pb2.Room)
...
def test_create_room_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == messaging_pb2.CreateRoomRequest(
        )
...
@pytest.mark.asyncio
async def test_create_room_async(transport: str = 'grpc_asyncio', request_type=messaging_pb2.CreateRoomRequest):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(messaging_pb2.Room(
            name='name_value',
            display_name='display_name_value',
            description='description_value',
        ))
...
def test_get_room_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == messaging_pb2.GetRoomRequest(
            name='name_value',
        )
...
@pytest.mark.asyncio
async def test_get_room_async(transport: str = 'grpc_asyncio', request_type=messaging_pb2.GetRoomRequest):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_room_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == messaging_pb2.UpdateRoomRequest(
        )
...
@pytest.mark.asyncio
async def test_update_room_async(transport: str = 'grpc_asyncio', request_type=messaging_pb2.UpdateRoomRequest):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_room_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == messaging_pb2.DeleteRoomRequest(
            name='name_value',
        )
...
@pytest.mark.asyncio
async def test_delete_room_async(transport: str = 'grpc_asyncio', request_type=messaging_pb2.DeleteRoomRequest):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_rooms(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = messaging_pb2.ListRoomsResponse(
...
def test_list_rooms_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == messaging_pb2.ListRoomsRequest(
            page_token='page_token_value',
        )
...
@pytest.mark.asyncio
async def test_list_rooms_async(transport: str = 'grpc_asyncio', request_type=messaging_pb2.ListRoomsRequest):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(messaging_pb2.ListRoomsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_rooms_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, messaging_pb2.Room)
                   for i in results)
...
def test_create_blurb(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = messaging_pb2.Blurb(
            name='name_value',
            user='user_value',
            text='text_value',
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, messaging_pb2.Blurb)
    assert response.name == 'name_value'
...
def test_create_blurb_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == messaging_pb2.CreateBlurbRequest(
            parent='parent_value',
        )
...
@pytest.mark.asyncio
async def test_create_blurb_async(transport: str = 'grpc_asyncio', request_type=messaging_pb2.CreateBlurbRequest):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(messaging_pb2.Blurb(
            name='name_value',
            user='user_value',
        ))
...
def test_get_blurb_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == messaging_pb2.GetBlurbRequest(
            name='name_value',
        )
...
@pytest.mark.asyncio
async def test_get_blurb_async(transport: str = 'grpc_asyncio', request_type=messaging_pb2.GetBlurbRequest):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_blurb_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == messaging_pb2.UpdateBlurbRequest(
        )
...
@pytest.mark.asyncio
async def test_update_blurb_async(transport: str = 'grpc_asyncio', request_type=messaging_pb2.UpdateBlurbRequest):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_blurb_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == messaging_pb2.DeleteBlurbRequest(
            name='name_value',
        )
...
@pytest.mark.asyncio
async def test_delete_blurb_async(transport: str = 'grpc_asyncio', request_type=messaging_pb2.DeleteBlurbRequest):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_blurbs(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = messaging_pb2.ListBlurbsResponse(
            next_page_token='next_page_token_value',
        )
...
def test_list_blurbs_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == messaging_pb2.ListBlurbsRequest(
            parent='parent_value',
            page_token='page_token_value',
        )
...
@pytest.mark.asyncio
async def test_list_blurbs_async(transport: str = 'grpc_asyncio', request_type=messaging_pb2.ListBlurbsRequest):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(messaging_pb2.ListBlurbsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_blurbs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, messaging_pb2.Blurb)
                   for i in results)
...
def test_search_blurbs_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == messaging_pb2.SearchBlurbsRequest(
            query='query_value',
            parent='parent_value',
            page_token='page_token_value',
        )
...
@pytest.mark.asyncio
async def test_search_blurbs_async(transport: str = 'grpc_asyncio', request_type=messaging_pb2.SearchBlurbsRequest):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_search_blurbs_raw_page_lro():
    response = messaging_pb2.SearchBlurbsResponse()
...
def test_stream_blurbs(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = iter([messaging_pb2.StreamBlurbsResponse()])
    ...
    for message in response:
        assert isinstance(message, messaging_pb2.StreamBlurbsResponse)
...
def test_stream_blurbs_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == messaging_pb2.StreamBlurbsRequest(
            name='name_value',
        )
...
@pytest.mark.asyncio
async def test_stream_blurbs_async(transport: str = 'grpc_asyncio', request_type=messaging_pb2.StreamBlurbsRequest):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        call.return_value.read = mock.AsyncMock(side_effect=[messaging_pb2.StreamBlurbsResponse()])
...
def test_send_blurbs(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = messaging_pb2.SendBlurbsResponse(
            names=['names_value'],
        )
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, messaging_pb2.SendBlurbsResponse)
...
@pytest.mark.asyncio
async def test_send_blurbs_async(transport: str = 'grpc_asyncio', request_type=messaging_pb2.CreateBlurbRequest):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeStreamUnaryCall(messaging_pb2.SendBlurbsResponse(
            names=['names_value'],
        ))
...
@pytest.mark.asyncio
async def test_connect_async(transport: str = 'grpc_asyncio', request_type=messaging_pb2.ConnectRequest):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_room_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        return_value = messaging_pb2.Room()
...
def test_get_room_rest_required_fields(request_type=messaging_pb2.GetRoomRequest):
...
def test_delete_room_rest_required_fields(request_type=messaging_pb2.DeleteRoomRequest):
    transport_class = transports.MessagingRestTransport
...
def test_list_rooms_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(messaging_pb2.ListRoomsResponse.to_json(x) for x in response)
...
def test_create_blurb_rest_required_fields(request_type=messaging_pb2.CreateBlurbRequest):
    transport_class = transports.MessagingRestTransport
    ...
    # Designate an appropriate value for the returned response.
    return_value = messaging_pb2.Blurb()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
...
def test_get_blurb_rest_required_fields(request_type=messaging_pb2.GetBlurbRequest):
    transport_class = transports.MessagingRestTransport
...
def test_delete_blurb_rest_required_fields(request_type=messaging_pb2.DeleteBlurbRequest):
    transport_class = transports.MessagingRestTransport
...
def test_list_blurbs_rest_required_fields(request_type=messaging_pb2.ListBlurbsRequest):
    transport_class = transports.MessagingRestTransport
    ...
    # Designate an appropriate value for the returned response.
    return_value = messaging_pb2.ListBlurbsResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
...
def test_list_blurbs_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(messaging_pb2.ListBlurbsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_search_blurbs_rest_required_fields(request_type=messaging_pb2.SearchBlurbsRequest):
    transport_class = transports.MessagingRestTransport
...
def test_stream_blurbs_rest_required_fields(request_type=messaging_pb2.StreamBlurbsRequest):
    transport_class = transports.MessagingRestTransport
    ...
    # Designate an appropriate value for the returned response.
    return_value = messaging_pb2.StreamBlurbsResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
...
def test_create_room_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = messaging_pb2.CreateRoomRequest()
...
def test_get_room_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = messaging_pb2.GetRoomRequest()
...
def test_update_room_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = messaging_pb2.UpdateRoomRequest()
...
def test_delete_room_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = messaging_pb2.DeleteRoomRequest()
...
def test_list_rooms_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = messaging_pb2.ListRoomsRequest()
...
def test_create_blurb_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = messaging_pb2.CreateBlurbRequest()
...
def test_get_blurb_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = messaging_pb2.GetBlurbRequest()
...
def test_update_blurb_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = messaging_pb2.UpdateBlurbRequest()
...
def test_delete_blurb_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = messaging_pb2.DeleteBlurbRequest()
...
def test_list_blurbs_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = messaging_pb2.ListBlurbsRequest()
...
def test_search_blurbs_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = messaging_pb2.SearchBlurbsRequest()
...
def test_stream_blurbs_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = messaging_pb2.StreamBlurbsRequest()
...
def test_create_room_rest_bad_request(request_type=messaging_pb2.CreateRoomRequest):
    client = MessagingClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_room_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pb_message = messaging_pb2.CreateRoomRequest()
        ...
        return_value = json_format.MessageToJson(messaging_pb2.Room())
        ...
        post.return_value = messaging_pb2.Room()
...
def test_get_room_rest_bad_request(request_type=messaging_pb2.GetRoomRequest):
    client = MessagingClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_room_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = messaging_pb2.GetRoomRequest()
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_room_rest_bad_request(request_type=messaging_pb2.UpdateRoomRequest):
    client = MessagingClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_room_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = messaging_pb2.UpdateRoomRequest()
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_room_rest_bad_request(request_type=messaging_pb2.DeleteRoomRequest):
    client = MessagingClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_room_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pre.assert_not_called()
        pb_message = messaging_pb2.DeleteRoomRequest()
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_rooms_rest_bad_request(request_type=messaging_pb2.ListRoomsRequest):
    client = MessagingClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_rooms_rest_call_success(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        # Designate an appropriate value for the returned response.
        return_value = messaging_pb2.ListRoomsResponse(
              next_page_token='next_page_token_value',
        )
...
def test_list_rooms_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = messaging_pb2.ListRoomsRequest()
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value = mock.Mock()
        req.return_value.status_code = 200
        return_value = json_format.MessageToJson(messaging_pb2.ListRoomsResponse())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = messaging_pb2.ListRoomsResponse()
...
def test_create_blurb_rest_bad_request(request_type=messaging_pb2.CreateBlurbRequest):
    client = MessagingClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_blurb_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = messaging_pb2.CreateBlurbRequest()
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value = mock.Mock()
        req.return_value.status_code = 200
        return_value = json_format.MessageToJson(messaging_pb2.Blurb())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = messaging_pb2.Blurb()
...
def test_get_blurb_rest_bad_request(request_type=messaging_pb2.GetBlurbRequest):
    client = MessagingClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_blurb_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = messaging_pb2.GetBlurbRequest()
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_blurb_rest_bad_request(request_type=messaging_pb2.UpdateBlurbRequest):
    client = MessagingClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_blurb_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = messaging_pb2.UpdateBlurbRequest()
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_blurb_rest_bad_request(request_type=messaging_pb2.DeleteBlurbRequest):
    client = MessagingClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_blurb_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pre.assert_not_called()
        pb_message = messaging_pb2.DeleteBlurbRequest()
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_blurbs_rest_bad_request(request_type=messaging_pb2.ListBlurbsRequest):
    client = MessagingClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_blurbs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = messaging_pb2.ListBlurbsRequest()
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value = mock.Mock()
        req.return_value.status_code = 200
        return_value = json_format.MessageToJson(messaging_pb2.ListBlurbsResponse())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = messaging_pb2.ListBlurbsResponse()
...
def test_search_blurbs_rest_bad_request(request_type=messaging_pb2.SearchBlurbsRequest):
    client = MessagingClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_search_blurbs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = messaging_pb2.SearchBlurbsRequest()
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_stream_blurbs_rest_bad_request(request_type=messaging_pb2.StreamBlurbsRequest):
    client = MessagingClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_stream_blurbs_rest_call_success(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        # Designate an appropriate value for the returned response.
        return_value = messaging_pb2.StreamBlurbsResponse(
              action=messaging_pb2.StreamBlurbsResponse.Action.CREATE,
        )
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, messaging_pb2.StreamBlurbsResponse)
    assert response.action == messaging_pb2.StreamBlurbsResponse.Action.CREATE
...
def test_stream_blurbs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = messaging_pb2.StreamBlurbsRequest()
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value = mock.Mock()
        req.return_value.status_code = 200
        return_value = json_format.MessageToJson(messaging_pb2.StreamBlurbsResponse())
        ...
        pre.return_value = request, metadata
        post.return_value = messaging_pb2.StreamBlurbsResponse()
...
def test_transport_kind_rest_asyncio():
    ...
    transport = MessagingAsyncClient.get_transport_class("rest_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
@pytest.mark.asyncio
async def test_create_room_rest_asyncio_bad_request(request_type=messaging_pb2.CreateRoomRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_create_room_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_create_room_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncMessagingRestTransport(
        credentials=async_anonymous_credentials(),
        interceptor=None if null_interceptor else transports.AsyncMessagingRestInterceptor(),
        )
    client = MessagingAsyncClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "post_create_room") as post, \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "pre_create_room") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = messaging_pb2.CreateRoomRequest()
        transcode.return_value = {
        ...
        await client.create_room(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()

@pytest.mark.asyncio
async def test_get_room_rest_asyncio_bad_request(request_type=messaging_pb2.GetRoomRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_get_room_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_get_room_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncMessagingRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "post_get_room") as post, \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "pre_get_room") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = messaging_pb2.GetRoomRequest()
        transcode.return_value = {
        ...
        await client.get_room(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()

@pytest.mark.asyncio
async def test_update_room_rest_asyncio_bad_request(request_type=messaging_pb2.UpdateRoomRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_update_room_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_update_room_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncMessagingRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "post_update_room") as post, \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "pre_update_room") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = messaging_pb2.UpdateRoomRequest()
        transcode.return_value = {
        ...
        await client.update_room(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()

@pytest.mark.asyncio
async def test_delete_room_rest_asyncio_bad_request(request_type=messaging_pb2.DeleteRoomRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_delete_room_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_delete_room_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncMessagingRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "pre_delete_room") as pre:
        pre.assert_not_called()
        pb_message = messaging_pb2.DeleteRoomRequest()
        transcode.return_value = {
            "method": "post",
        ...
        await client.delete_room(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()

@pytest.mark.asyncio
async def test_list_rooms_rest_asyncio_bad_request(request_type=messaging_pb2.ListRoomsRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_list_rooms_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_list_rooms_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncMessagingRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "post_list_rooms") as post, \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "pre_list_rooms") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = messaging_pb2.ListRoomsRequest()
        transcode.return_value = {
        ...
        await client.list_rooms(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()

@pytest.mark.asyncio
async def test_create_blurb_rest_asyncio_bad_request(request_type=messaging_pb2.CreateBlurbRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_create_blurb_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_create_blurb_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncMessagingRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "post_create_blurb") as post, \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "pre_create_blurb") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = messaging_pb2.CreateBlurbRequest()
        transcode.return_value = {
        ...
        await client.create_blurb(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()

@pytest.mark.asyncio
async def test_get_blurb_rest_asyncio_bad_request(request_type=messaging_pb2.GetBlurbRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_get_blurb_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_get_blurb_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncMessagingRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "post_get_blurb") as post, \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "pre_get_blurb") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = messaging_pb2.GetBlurbRequest()
        transcode.return_value = {
        ...
        await client.get_blurb(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()

@pytest.mark.asyncio
async def test_update_blurb_rest_asyncio_bad_request(request_type=messaging_pb2.UpdateBlurbRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_update_blurb_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_update_blurb_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncMessagingRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "post_update_blurb") as post, \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "pre_update_blurb") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = messaging_pb2.UpdateBlurbRequest()
        transcode.return_value = {
        ...
        await client.update_blurb(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()

@pytest.mark.asyncio
async def test_delete_blurb_rest_asyncio_bad_request(request_type=messaging_pb2.DeleteBlurbRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_delete_blurb_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_delete_blurb_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncMessagingRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "pre_delete_blurb") as pre:
        pre.assert_not_called()
        pb_message = messaging_pb2.DeleteBlurbRequest()
        transcode.return_value = {
            "method": "post",
        ...
        await client.delete_blurb(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()

@pytest.mark.asyncio
async def test_list_blurbs_rest_asyncio_bad_request(request_type=messaging_pb2.ListBlurbsRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_list_blurbs_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_list_blurbs_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncMessagingRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "post_list_blurbs") as post, \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "pre_list_blurbs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = messaging_pb2.ListBlurbsRequest()
        transcode.return_value = {
        ...
        await client.list_blurbs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()

@pytest.mark.asyncio
async def test_search_blurbs_rest_asyncio_bad_request(request_type=messaging_pb2.SearchBlurbsRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_search_blurbs_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_search_blurbs_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncMessagingRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "post_search_blurbs") as post, \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "pre_search_blurbs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = messaging_pb2.SearchBlurbsRequest()
        transcode.return_value = {
        ...
        await client.search_blurbs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()

@pytest.mark.asyncio
async def test_stream_blurbs_rest_asyncio_bad_request(request_type=messaging_pb2.StreamBlurbsRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_stream_blurbs_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_stream_blurbs_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncMessagingRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "post_stream_blurbs") as post, \
        mock.patch.object(transports.AsyncMessagingRestInterceptor, "pre_stream_blurbs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = messaging_pb2.StreamBlurbsRequest()
        transcode.return_value = {
        ...
        await client.stream_blurbs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()

@pytest.mark.asyncio
async def test_send_blurbs_rest_asyncio_error():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
...
@pytest.mark.asyncio
async def test_connect_rest_asyncio_error():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_room_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_room_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_room_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_room_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_rooms_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_blurb_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_blurb_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_blurb_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_blurb_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_blurbs_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_search_blurbs_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_stream_blurbs_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
...
def test_messaging_rest_asyncio_lro_client():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
