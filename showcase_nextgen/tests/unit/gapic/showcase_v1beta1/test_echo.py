...
def test_echo(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
        ...
        call.return_value = echo_pb2.EchoResponse(
            content='content_value',
            severity=echo_pb2.Severity.NECESSARY,
    ...
    assert isinstance(response, echo_pb2.EchoResponse)
    assert response.content == 'content_value'
    assert response.severity == echo_pb2.Severity.NECESSARY
...
def test_echo_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        assert args[0] == echo_pb2.EchoRequest(
            content='content_value',
            header='header_value',
            other_header='other_header_value',
        )
...
@pytest.mark.asyncio
async def test_echo_async(transport: str = 'grpc_asyncio', request_type=echo_pb2.EchoRequest):
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(echo_pb2.EchoResponse(
            content='content_value',
            severity=echo_pb2.Severity.NECESSARY,
            request_id='request_id_value',
            other_request_id='other_request_id_value',
...
def test_echo_error_details(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = echo_pb2.EchoErrorDetailsResponse(
        )
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, echo_pb2.EchoErrorDetailsResponse)
...
def test_echo_error_details_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == echo_pb2.EchoErrorDetailsRequest(
            single_detail_text='single_detail_text_value',
        )
...
@pytest.mark.asyncio
async def test_echo_error_details_async(transport: str = 'grpc_asyncio', request_type=echo_pb2.EchoErrorDetailsRequest):
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(echo_pb2.EchoErrorDetailsResponse(
        ))
...
def test_expand(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = iter([echo_pb2.EchoResponse()])
    ...
    for message in response:
        assert isinstance(message, echo_pb2.EchoResponse)
...
def test_expand_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == echo_pb2.ExpandRequest(
            content='content_value',
        )
...
@pytest.mark.asyncio
async def test_expand_async(transport: str = 'grpc_asyncio', request_type=echo_pb2.ExpandRequest):
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        call.return_value.read = mock.AsyncMock(side_effect=[echo_pb2.EchoResponse()])
...
@pytest.mark.asyncio
async def test_collect_async(transport: str = 'grpc_asyncio', request_type=echo_pb2.EchoRequest):
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeStreamUnaryCall(echo_pb2.EchoResponse(
            content='content_value',
            severity=echo_pb2.Severity.NECESSARY,
            request_id='request_id_value',
            other_request_id='other_request_id_value',
...
@pytest.mark.asyncio
async def test_chat_async(transport: str = 'grpc_asyncio', request_type=echo_pb2.EchoRequest):
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_paged_expand(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = echo_pb2.PagedExpandResponse(
...
def test_paged_expand_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == echo_pb2.PagedExpandRequest(
            content='content_value',
            page_token='page_token_value',
        )
...
@pytest.mark.asyncio
async def test_paged_expand_async(transport: str = 'grpc_asyncio', request_type=echo_pb2.PagedExpandRequest):
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(echo_pb2.PagedExpandResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_paged_expand_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, echo_pb2.EchoResponse)
                   for i in results)
...
def test_paged_expand_legacy_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == echo_pb2.PagedExpandLegacyRequest(
            content='content_value',
            page_token='page_token_value',
        )
...
@pytest.mark.asyncio
async def test_paged_expand_legacy_async(transport: str = 'grpc_asyncio', request_type=echo_pb2.PagedExpandLegacyRequest):
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_paged_expand_legacy_mapped(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = echo_pb2.PagedExpandLegacyMappedResponse(
            next_page_token='next_page_token_value',
        )
...
@pytest.mark.asyncio
async def test_paged_expand_legacy_mapped_async(transport: str = 'grpc_asyncio', request_type=echo_pb2.PagedExpandRequest):
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(echo_pb2.PagedExpandLegacyMappedResponse(
            next_page_token='next_page_token_value',
        ))
    ...
    with mock.patch.object(
        ...
        call.side_effect = (
            echo_pb2.PagedExpandLegacyMappedResponse(
                alphabetized={
                    'a':echo_pb2.PagedExpandResponseList(),
                    'b':echo_pb2.PagedExpandResponseList(),
                    'c':echo_pb2.PagedExpandResponseList(),
                },
                next_page_token='abc',
            ),
            echo_pb2.PagedExpandLegacyMappedResponse(
            ...
            echo_pb2.PagedExpandLegacyMappedResponse(
                alphabetized={
                    'g':echo_pb2.PagedExpandResponseList(),
                },
                next_page_token='ghi',
            ),
            echo_pb2.PagedExpandLegacyMappedResponse(
                alphabetized={
                    'h':echo_pb2.PagedExpandResponseList(),
                    'i':echo_pb2.PagedExpandResponseList(),
                },
            ),
            RuntimeError,
        )
...
async def test_paged_expand_legacy_mapped_async_pager():
    ...
    with mock.patch.object(
        ...
        for result in responses:
            ...
            assert tuple(type(t) for t in result) == (str, echo_pb2.PagedExpandResponseList)

        assert async_pager.get('a') is None
        assert isinstance(async_pager.get('h'), echo_pb2.PagedExpandResponseList)
...
def test_wait_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == echo_pb2.WaitRequest(
        )
...
@pytest.mark.asyncio
async def test_wait_async(transport: str = 'grpc_asyncio', request_type=echo_pb2.WaitRequest):
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_block(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = echo_pb2.BlockResponse(
            content='content_value',
        )
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, echo_pb2.BlockResponse)
    assert response.content == 'content_value'
...
def test_block_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == echo_pb2.BlockRequest(
        )
...
@pytest.mark.asyncio
async def test_block_async(transport: str = 'grpc_asyncio', request_type=echo_pb2.BlockRequest):
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(echo_pb2.BlockResponse(
            content='content_value',
        ))
...
def test_expand_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        return_value = echo_pb2.EchoResponse()
...
def test_paged_expand_rest_required_fields(request_type=echo_pb2.PagedExpandRequest):
    ...
    # Designate an appropriate value for the returned response.
    return_value = echo_pb2.PagedExpandResponse()
    # Mock the http request call within the method and fake a response.
...
def test_paged_expand_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(echo_pb2.PagedExpandResponse.to_json(x) for x in response)
...
def test_paged_expand_legacy_rest_required_fields(request_type=echo_pb2.PagedExpandLegacyRequest):
    transport_class = transports.EchoRestTransport
...
def test_paged_expand_legacy_mapped_rest_required_fields(request_type=echo_pb2.PagedExpandRequest):
    transport_class = transports.EchoRestTransport
    ...
    # Designate an appropriate value for the returned response.
    return_value = echo_pb2.PagedExpandLegacyMappedResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
...
def test_paged_expand_legacy_mapped_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(echo_pb2.PagedExpandLegacyMappedResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        assert isinstance(pager.get('a'), echo_pb2.PagedExpandResponseList)
        ...
        assert isinstance(pager.get('h'), echo_pb2.PagedExpandResponseList)
...
def test_echo_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        # clear UUID field so that the check below succeeds
        args[0].other_request_id = None
        request_msg = echo_pb2.EchoRequest()
...
def test_echo_error_details_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = echo_pb2.EchoErrorDetailsRequest()
...
def test_expand_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = echo_pb2.ExpandRequest()
...
def test_paged_expand_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = echo_pb2.PagedExpandRequest()
...
def test_paged_expand_legacy_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = echo_pb2.PagedExpandLegacyRequest()
...
def test_wait_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = echo_pb2.WaitRequest()
...
def test_block_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = echo_pb2.BlockRequest()
...
def test_echo_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
        ...
        # clear UUID field so that the check below succeeds
        args[0].other_request_id = None
        request_msg = echo_pb2.EchoRequest(**{"header": "sample1"})
...
def test_echo_routing_parameters_request_3_grpc():
    ...
    with mock.patch.object(
        ...
        # clear UUID field so that the check below succeeds
        args[0].other_request_id = None
        request_msg = echo_pb2.EchoRequest(**{"header": "regions/sample1/zones/sample2/sample3"})
...
def test_echo_routing_parameters_request_4_grpc():
    ...
    with mock.patch.object(
        ...
        # clear UUID field so that the check below succeeds
        args[0].other_request_id = None
        request_msg = echo_pb2.EchoRequest(**{"header": "projects/sample1/sample2"})
...
def test_echo_routing_parameters_request_5_grpc():
    ...
    with mock.patch.object(
        ...
        # clear UUID field so that the check below succeeds
        args[0].other_request_id = None
        request_msg = echo_pb2.EchoRequest(**{"header": "projects/sample1/instances/sample2/sample3"})
...
def test_echo_routing_parameters_request_7_grpc():
    ...
    with mock.patch.object(
        ...
        # clear UUID field so that the check below succeeds
        args[0].other_request_id = None
        request_msg = echo_pb2.EchoRequest(**{"other_header": "sample1"})
...
def test_echo_routing_parameters_request_8_grpc():
    ...
    with mock.patch.object(
        ...
        # clear UUID field so that the check below succeeds
        args[0].other_request_id = None
        request_msg = echo_pb2.EchoRequest(**{"other_header": "projects/sample1/sample2"})
...
def test_echo_rest_bad_request(request_type=echo_pb2.EchoRequest):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_echo_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pb_message = echo_pb2.EchoRequest()
        ...
        return_value = json_format.MessageToJson(echo_pb2.EchoResponse())
        ...
        post.return_value = echo_pb2.EchoResponse()
...
def test_echo_error_details_rest_bad_request(request_type=echo_pb2.EchoErrorDetailsRequest):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_echo_error_details_rest_call_success(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        # Designate an appropriate value for the returned response.
        return_value = echo_pb2.EchoErrorDetailsResponse(
        )
...
def test_echo_error_details_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = echo_pb2.EchoErrorDetailsRequest()
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value = mock.Mock()
        req.return_value.status_code = 200
        return_value = json_format.MessageToJson(echo_pb2.EchoErrorDetailsResponse())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = echo_pb2.EchoErrorDetailsResponse()
...
def test_expand_rest_bad_request(request_type=echo_pb2.ExpandRequest):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_expand_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = echo_pb2.ExpandRequest()
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_paged_expand_rest_bad_request(request_type=echo_pb2.PagedExpandRequest):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_paged_expand_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = echo_pb2.PagedExpandRequest()
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value = mock.Mock()
        req.return_value.status_code = 200
        return_value = json_format.MessageToJson(echo_pb2.PagedExpandResponse())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = echo_pb2.PagedExpandResponse()
...
def test_paged_expand_legacy_rest_bad_request(request_type=echo_pb2.PagedExpandLegacyRequest):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_paged_expand_legacy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = echo_pb2.PagedExpandLegacyRequest()
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_paged_expand_legacy_mapped_rest_bad_request(request_type=echo_pb2.PagedExpandRequest):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_paged_expand_legacy_mapped_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value = mock.Mock()
        req.return_value.status_code = 200
        return_value = json_format.MessageToJson(echo_pb2.PagedExpandLegacyMappedResponse())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = echo_pb2.PagedExpandLegacyMappedResponse()
...
def test_wait_rest_bad_request(request_type=echo_pb2.WaitRequest):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_wait_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = echo_pb2.WaitRequest()
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_block_rest_bad_request(request_type=echo_pb2.BlockRequest):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_block_rest_call_success(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        # Designate an appropriate value for the returned response.
        return_value = echo_pb2.BlockResponse(
              content='content_value',
        )
...
def test_block_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = echo_pb2.BlockRequest()
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value = mock.Mock()
        req.return_value.status_code = 200
        return_value = json_format.MessageToJson(echo_pb2.BlockResponse())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = echo_pb2.BlockResponse()
...
def test_transport_kind_rest_asyncio():
    ...
    transport = EchoAsyncClient.get_transport_class("rest_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
@pytest.mark.asyncio
async def test_echo_rest_asyncio_bad_request(request_type=echo_pb2.EchoRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_echo_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_echo_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncEchoRestTransport(
        credentials=async_anonymous_credentials(),
        interceptor=None if null_interceptor else transports.AsyncEchoRestInterceptor(),
        )
    client = EchoAsyncClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncEchoRestInterceptor, "post_echo") as post, \
        mock.patch.object(transports.AsyncEchoRestInterceptor, "pre_echo") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = echo_pb2.EchoRequest()
        transcode.return_value = {
        ...
        await client.echo(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()

@pytest.mark.asyncio
async def test_echo_error_details_rest_asyncio_bad_request(request_type=echo_pb2.EchoErrorDetailsRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_echo_error_details_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_echo_error_details_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncEchoRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncEchoRestInterceptor, "post_echo_error_details") as post, \
        mock.patch.object(transports.AsyncEchoRestInterceptor, "pre_echo_error_details") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = echo_pb2.EchoErrorDetailsRequest()
        transcode.return_value = {
        ...
        await client.echo_error_details(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()

@pytest.mark.asyncio
async def test_expand_rest_asyncio_bad_request(request_type=echo_pb2.ExpandRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_expand_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_expand_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncEchoRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncEchoRestInterceptor, "post_expand") as post, \
        mock.patch.object(transports.AsyncEchoRestInterceptor, "pre_expand") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = echo_pb2.ExpandRequest()
        transcode.return_value = {
        ...
        await client.expand(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()

@pytest.mark.asyncio
async def test_collect_rest_asyncio_error():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
...
@pytest.mark.asyncio
async def test_chat_rest_asyncio_error():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
...
@pytest.mark.asyncio
async def test_paged_expand_rest_asyncio_bad_request(request_type=echo_pb2.PagedExpandRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_paged_expand_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_paged_expand_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncEchoRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncEchoRestInterceptor, "post_paged_expand") as post, \
        mock.patch.object(transports.AsyncEchoRestInterceptor, "pre_paged_expand") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = echo_pb2.PagedExpandRequest()
        transcode.return_value = {
        ...
        await client.paged_expand(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()

@pytest.mark.asyncio
async def test_paged_expand_legacy_rest_asyncio_bad_request(request_type=echo_pb2.PagedExpandLegacyRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_paged_expand_legacy_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_paged_expand_legacy_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncEchoRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncEchoRestInterceptor, "post_paged_expand_legacy") as post, \
        mock.patch.object(transports.AsyncEchoRestInterceptor, "pre_paged_expand_legacy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = echo_pb2.PagedExpandLegacyRequest()
        transcode.return_value = {
        ...
        await client.paged_expand_legacy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()

@pytest.mark.asyncio
async def test_paged_expand_legacy_mapped_rest_asyncio_bad_request(request_type=echo_pb2.PagedExpandRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_paged_expand_legacy_mapped_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_paged_expand_legacy_mapped_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncEchoRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncEchoRestInterceptor, "post_paged_expand_legacy_mapped") as post, \
        mock.patch.object(transports.AsyncEchoRestInterceptor, "pre_paged_expand_legacy_mapped") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = echo_pb2.PagedExpandRequest()
        transcode.return_value = {
        ...
        await client.paged_expand_legacy_mapped(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()

@pytest.mark.asyncio
async def test_wait_rest_asyncio_bad_request(request_type=echo_pb2.WaitRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_wait_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_wait_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncEchoRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncEchoRestInterceptor, "post_wait") as post, \
        mock.patch.object(transports.AsyncEchoRestInterceptor, "pre_wait") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = echo_pb2.WaitRequest()
        transcode.return_value = {
        ...
        await client.wait(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()

@pytest.mark.asyncio
async def test_block_rest_asyncio_bad_request(request_type=echo_pb2.BlockRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_block_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_block_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncEchoRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncEchoRestInterceptor, "post_block") as post, \
        mock.patch.object(transports.AsyncEchoRestInterceptor, "pre_block") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = echo_pb2.BlockRequest()
        transcode.return_value = {
        ...
        await client.block(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_echo_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_echo_error_details_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_expand_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_paged_expand_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_paged_expand_legacy_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_paged_expand_legacy_mapped_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_wait_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_block_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
async def test_echo_routing_parameters_request_1_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
async def test_echo_routing_parameters_request_2_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
async def test_echo_routing_parameters_request_3_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
async def test_echo_routing_parameters_request_4_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
async def test_echo_routing_parameters_request_5_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
async def test_echo_routing_parameters_request_6_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
async def test_echo_routing_parameters_request_7_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
async def test_echo_routing_parameters_request_8_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
...
def test_echo_rest_asyncio_lro_client():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EchoAsyncClient(
        credentials=async_anonymous_credentials(),
