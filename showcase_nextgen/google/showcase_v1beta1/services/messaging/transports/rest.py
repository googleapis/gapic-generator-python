...
class MessagingRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_blurb(self, request: messaging_pb2.CreateBlurbRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[messaging_pb2.CreateBlurbRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_create_blurb(self, response: messaging_pb2.Blurb) -> messaging_pb2.Blurb:
    ...
    def pre_create_room(self, request: messaging_pb2.CreateRoomRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[messaging_pb2.CreateRoomRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_create_room(self, response: messaging_pb2.Room) -> messaging_pb2.Room:
    ...
    def pre_delete_blurb(self, request: messaging_pb2.DeleteBlurbRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[messaging_pb2.DeleteBlurbRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_room(self, request: messaging_pb2.DeleteRoomRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[messaging_pb2.DeleteRoomRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_blurb(self, request: messaging_pb2.GetBlurbRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[messaging_pb2.GetBlurbRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_blurb(self, response: messaging_pb2.Blurb) -> messaging_pb2.Blurb:
    ...
    def pre_get_room(self, request: messaging_pb2.GetRoomRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[messaging_pb2.GetRoomRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_room(self, response: messaging_pb2.Room) -> messaging_pb2.Room:
    ...
    def pre_list_blurbs(self, request: messaging_pb2.ListBlurbsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[messaging_pb2.ListBlurbsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_blurbs(self, response: messaging_pb2.ListBlurbsResponse) -> messaging_pb2.ListBlurbsResponse:
    ...
    def pre_list_rooms(self, request: messaging_pb2.ListRoomsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[messaging_pb2.ListRoomsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_rooms(self, response: messaging_pb2.ListRoomsResponse) -> messaging_pb2.ListRoomsResponse:
    ...
    def pre_search_blurbs(self, request: messaging_pb2.SearchBlurbsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[messaging_pb2.SearchBlurbsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_stream_blurbs(self, request: messaging_pb2.StreamBlurbsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[messaging_pb2.StreamBlurbsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_blurb(self, request: messaging_pb2.UpdateBlurbRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[messaging_pb2.UpdateBlurbRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_update_blurb(self, response: messaging_pb2.Blurb) -> messaging_pb2.Blurb:
    ...
    def pre_update_room(self, request: messaging_pb2.UpdateRoomRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[messaging_pb2.UpdateRoomRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_update_room(self, response: messaging_pb2.Room) -> messaging_pb2.Room:
...
class MessagingRestTransport(_BaseMessagingRestTransport):
    ...
    class _StreamBlurbs(_BaseMessagingRestTransport._BaseStreamBlurbs, MessagingRestStub):
        ...
        def __call__(self,
            ...
            # Return the response
            resp = rest_streaming.ResponseIterator(response, messaging_pb2.StreamBlurbsResponse)
