...
try:
    from .transports.rest_asyncio import AsyncEchoRestTransport
...
class EchoClientMeta(type):
    ...
    if HAS_ASYNC_REST_DEPENDENCIES:  # pragma: NO COVER
        _transport_registry["rest_asyncio"] = AsyncEchoRestTransport
...
class EchoClient(metaclass=EchoClientMeta):
    ...
    def echo(self,
        ...
        Args:
            request (Union[google.showcase_v1beta1.types.EchoRequest_pb2, dict]):
    ...
    def echo_error_details(self,
        ...
        Args:
            request (Union[google.showcase_v1beta1.types.EchoErrorDetailsRequest_pb2, dict]):
                The request object. The request message used for the
    ...
    def expand(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> Iterable[echo_pb2.EchoResponse]:
        ...
        Args:
            request (Union[google.showcase_v1beta1.types.ExpandRequest_pb2, dict]):
        ...
        Returns:
            Iterable[google.showcase_v1beta1.types.EchoResponse_pb2]:
                The response message for the Echo
                methods.
    ...
    def collect(self,
            requests: Optional[Iterator[echo_pb2.EchoRequest]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        Args:
            requests (Iterator[google.showcase_v1beta1.types.EchoRequest_pb2]):
    ...
    def paged_expand(self,
        ...
        Args:
            request (Union[google.showcase_v1beta1.types.PagedExpandRequest_pb2, dict]):
    ...
    def paged_expand_legacy(self,
        ...
        Args:
            request (Union[google.showcase_v1beta1.types.PagedExpandLegacyRequest_pb2, dict]):
    ...
    def wait(self,
        ...
        Args:
            request (Union[google.showcase_v1beta1.types.WaitRequest_pb2, dict]):
    ...
    def block(self,
        ...
        Args:
            request (Union[google.showcase_v1beta1.types.BlockRequest_pb2, dict]):
