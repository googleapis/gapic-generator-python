...
class EchoGrpcAsyncIOTransport(EchoTransport):
    ...
    def echo(self) -> Callable[
            ...
            Awaitable[echo_pb2.EchoResponse]]:
    ...
    def echo_error_details(self) -> Callable[
            ...
            Awaitable[echo_pb2.EchoErrorDetailsResponse]]:
        ...
        if 'echo_error_details' not in self._stubs:
            self._stubs['echo_error_details'] = self.grpc_channel.unary_unary(
                '/google.showcase.v1beta1.Echo/EchoErrorDetails',
                request_serializer=echo_pb2.EchoErrorDetailsRequest.SerializeToString,
                response_deserializer=echo_pb2.EchoErrorDetailsResponse.FromString,
            )
    ...
    def expand(self) -> Callable[
        ...
        if 'expand' not in self._stubs:
            self._stubs['expand'] = self.grpc_channel.unary_stream(
                ...
                request_serializer=echo_pb2.ExpandRequest.SerializeToString,
                response_deserializer=echo_pb2.EchoResponse.FromString,
            )
    ...
    def paged_expand(self) -> Callable[
            ...
            Awaitable[echo_pb2.PagedExpandResponse]]:
        ...
        if 'paged_expand' not in self._stubs:
            self._stubs['paged_expand'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=echo_pb2.PagedExpandRequest.SerializeToString,
                response_deserializer=echo_pb2.PagedExpandResponse.FromString,
            )
    ...
    def paged_expand_legacy(self) -> Callable[
        ...
        if 'paged_expand_legacy' not in self._stubs:
            self._stubs['paged_expand_legacy'] = self.grpc_channel.unary_unary(
                '/google.showcase.v1beta1.Echo/PagedExpandLegacy',
                request_serializer=echo_pb2.PagedExpandLegacyRequest.SerializeToString,
                response_deserializer=echo_pb2.PagedExpandResponse.FromString,
            )
    ...
    def paged_expand_legacy_mapped(self) -> Callable[
            [echo_pb2.PagedExpandRequest],
            Awaitable[echo_pb2.PagedExpandLegacyMappedResponse]]:
        ...
        if 'paged_expand_legacy_mapped' not in self._stubs:
            self._stubs['paged_expand_legacy_mapped'] = self.grpc_channel.unary_unary(
                '/google.showcase.v1beta1.Echo/PagedExpandLegacyMapped',
                request_serializer=echo_pb2.PagedExpandRequest.SerializeToString,
                response_deserializer=echo_pb2.PagedExpandLegacyMappedResponse.FromString,
            )
    ...
    def wait(self) -> Callable[
        ...
        if 'wait' not in self._stubs:
            self._stubs['wait'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=echo_pb2.WaitRequest.SerializeToString,
    ...
    def block(self) -> Callable[
            ...
            Awaitable[echo_pb2.BlockResponse]]:
        ...
        if 'block' not in self._stubs:
            self._stubs['block'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=echo_pb2.BlockRequest.SerializeToString,
                response_deserializer=echo_pb2.BlockResponse.FromString,
            )
