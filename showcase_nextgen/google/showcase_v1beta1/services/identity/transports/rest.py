...
class IdentityRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_user(self, request: identity_pb2.CreateUserRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[identity_pb2.CreateUserRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_create_user(self, response: identity_pb2.User) -> identity_pb2.User:
    ...
    def pre_delete_user(self, request: identity_pb2.DeleteUserRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[identity_pb2.DeleteUserRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_user(self, request: identity_pb2.GetUserRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[identity_pb2.GetUserRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_user(self, response: identity_pb2.User) -> identity_pb2.User:
    ...
    def pre_list_users(self, request: identity_pb2.ListUsersRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[identity_pb2.ListUsersRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_users(self, response: identity_pb2.ListUsersResponse) -> identity_pb2.ListUsersResponse:
    ...
    def pre_update_user(self, request: identity_pb2.UpdateUserRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[identity_pb2.UpdateUserRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_update_user(self, response: identity_pb2.User) -> identity_pb2.User:
