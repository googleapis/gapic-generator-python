...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-redis.svg
   :target: https://pypi.org/project/google-cloud-redis/
.. _Google Cloud Memorystore for Redis API:
...
.. _Enable the Google Cloud Memorystore for Redis API.:
...
.. _Google Cloud Memorystore for Redis API Product documentation:
