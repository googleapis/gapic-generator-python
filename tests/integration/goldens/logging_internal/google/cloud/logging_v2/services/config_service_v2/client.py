...
class BaseConfigServiceV2Client(metaclass=BaseConfigServiceV2ClientMeta):
    ...
    def __init__(self, *,
        ...
        self._api_endpoint = (self._api_endpoint or
            BaseConfigServiceV2Client._get_api_endpoint(
    ...
    def _update_cmek_settings(self,
