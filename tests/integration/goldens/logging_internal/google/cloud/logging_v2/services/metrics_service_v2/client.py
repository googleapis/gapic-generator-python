...
class BaseMetricsServiceV2Client(metaclass=BaseMetricsServiceV2ClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = BaseMetricsServiceV2Client._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or BaseMetricsServiceV2Client._get_api_endpoint(
...
__all__ = ("BaseMetricsServiceV2Client",)
