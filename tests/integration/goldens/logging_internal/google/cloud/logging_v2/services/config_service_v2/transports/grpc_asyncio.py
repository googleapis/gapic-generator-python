...
class ConfigServiceV2GrpcAsyncIOTransport(ConfigServiceV2Transport):
    ...
    def list_buckets(
        self,
    ) -> Callable[[logging_config.ListBucketsRequest], Awaitable[logging_config.ListBucketsResponse]]:
    ...
    def get_bucket(
        self,
    ) -> Callable[[logging_config.GetBucketRequest], Awaitable[logging_config.LogBucket]]:
    ...
    def create_bucket_async(
        self,
    ) -> Callable[[logging_config.CreateBucketRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def update_bucket_async(
        self,
    ) -> Callable[[logging_config.UpdateBucketRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def create_bucket(
        self,
    ) -> Callable[[logging_config.CreateBucketRequest], Awaitable[logging_config.LogBucket]]:
    ...
    def update_bucket(
        self,
    ) -> Callable[[logging_config.UpdateBucketRequest], Awaitable[logging_config.LogBucket]]:
    ...
    def list_views(
        self,
    ) -> Callable[[logging_config.ListViewsRequest], Awaitable[logging_config.ListViewsResponse]]:
    ...
    def create_view(
        self,
    ) -> Callable[[logging_config.CreateViewRequest], Awaitable[logging_config.LogView]]:
    ...
    def update_view(
        self,
    ) -> Callable[[logging_config.UpdateViewRequest], Awaitable[logging_config.LogView]]:
    ...
    def list_sinks(
        self,
    ) -> Callable[[logging_config.ListSinksRequest], Awaitable[logging_config.ListSinksResponse]]:
    ...
    def create_sink(
        self,
    ) -> Callable[[logging_config.CreateSinkRequest], Awaitable[logging_config.LogSink]]:
    ...
    def update_sink(
        self,
    ) -> Callable[[logging_config.UpdateSinkRequest], Awaitable[logging_config.LogSink]]:
    ...
    def create_link(
        self,
    ) -> Callable[[logging_config.CreateLinkRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def delete_link(
        self,
    ) -> Callable[[logging_config.DeleteLinkRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def list_links(
        self,
    ) -> Callable[[logging_config.ListLinksRequest], Awaitable[logging_config.ListLinksResponse]]:
    ...
    def list_exclusions(
        self,
    ) -> Callable[[logging_config.ListExclusionsRequest], Awaitable[logging_config.ListExclusionsResponse]]:
    ...
    def get_exclusion(
        self,
    ) -> Callable[[logging_config.GetExclusionRequest], Awaitable[logging_config.LogExclusion]]:
    ...
    def create_exclusion(
        self,
    ) -> Callable[[logging_config.CreateExclusionRequest], Awaitable[logging_config.LogExclusion]]:
    ...
    def update_exclusion(
        self,
    ) -> Callable[[logging_config.UpdateExclusionRequest], Awaitable[logging_config.LogExclusion]]:
    ...
    def get_cmek_settings(
        self,
    ) -> Callable[[logging_config.GetCmekSettingsRequest], Awaitable[logging_config.CmekSettings]]:
    ...
    def update_cmek_settings(
        self,
    ) -> Callable[[logging_config.UpdateCmekSettingsRequest], Awaitable[logging_config.CmekSettings]]:
    ...
    def get_settings(
        self,
    ) -> Callable[[logging_config.GetSettingsRequest], Awaitable[logging_config.Settings]]:
    ...
    def update_settings(
        self,
    ) -> Callable[[logging_config.UpdateSettingsRequest], Awaitable[logging_config.Settings]]:
    ...
    def copy_log_entries(
        self,
    ) -> Callable[[logging_config.CopyLogEntriesRequest], Awaitable[operations_pb2.Operation]]:
