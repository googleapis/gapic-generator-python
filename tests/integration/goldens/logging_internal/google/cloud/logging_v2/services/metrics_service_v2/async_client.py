...
class BaseMetricsServiceV2AsyncClient:
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = None):
        ...
        """
        return BaseMetricsServiceV2Client.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore # fmt: skip
    ...
    def __init__(self, *,
        ...
        """
        self._client = BaseMetricsServiceV2Client(
    ...
    async def _update_log_metric(self,
        ...
        .. code-block:: python
            ...
            async def sample_update_log_metric():
                ...
                # Make the request
                response = await client._update_log_metric(request=request)
