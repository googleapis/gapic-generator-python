...
class ConfigServiceV2GrpcTransport(ConfigServiceV2Transport):
    ...
    def list_buckets(
        self,
    ) -> Callable[[logging_config.ListBucketsRequest], logging_config.ListBucketsResponse]:
    ...
    def list_exclusions(
        self,
    ) -> Callable[[logging_config.ListExclusionsRequest], logging_config.ListExclusionsResponse]:
    ...
    def update_cmek_settings(
        self,
    ) -> Callable[[logging_config.UpdateCmekSettingsRequest], logging_config.CmekSettings]:
