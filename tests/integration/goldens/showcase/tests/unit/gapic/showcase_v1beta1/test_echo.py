...
@pytest.mark.asyncio
async def test_echo_rest_asyncio_bad_request(request_type=gs_echo.EchoRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_echo_error_details_rest_asyncio_bad_request(request_type=gs_echo.EchoErrorDetailsRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_expand_rest_asyncio_bad_request(request_type=gs_echo.ExpandRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_paged_expand_rest_asyncio_error():
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_paged_expand_legacy_rest_asyncio_error():
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_paged_expand_legacy_mapped_rest_asyncio_error():
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_wait_rest_asyncio_error():
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_block_rest_asyncio_bad_request(request_type=gs_echo.BlockRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
