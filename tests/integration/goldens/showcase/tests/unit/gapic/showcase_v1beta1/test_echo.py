...
def test_echo_routing_parameters():
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    request = gs_echo.EchoRequest(**{"header": "sample1"})
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = gs_echo.EchoRequest(**{"header": "regions/sample1/zones/sample2/sample3"})
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = gs_echo.EchoRequest(**{"header": "projects/sample1/sample2"})
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = gs_echo.EchoRequest(**{"header": "projects/sample1/instances/sample2/sample3"})
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = gs_echo.EchoRequest(**{"other_header": "sample1"})
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = gs_echo.EchoRequest(**{"other_header": "projects/sample1/sample2"})
...
def test_echo_error_details_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_paged_expand_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_paged_expand_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        metadata = ()
        pager = client.paged_expand(request={})
...
def test_paged_expand_legacy_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_paged_expand_legacy_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        metadata = ()
        pager = client.paged_expand_legacy(request={})
...
def test_paged_expand_legacy_mapped_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_echo_rest(request_type):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_echo_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = gs_echo.EchoResponse.to_json(gs_echo.EchoResponse())
...
def test_echo_rest_bad_request(transport: str = 'rest', request_type=gs_echo.EchoRequest):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_echo_error_details_rest(request_type):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_echo_error_details_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gs_echo.EchoErrorDetailsResponse.to_json(gs_echo.EchoErrorDetailsResponse())
...
def test_echo_error_details_rest_bad_request(transport: str = 'rest', request_type=gs_echo.EchoErrorDetailsRequest):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_echo_error_details_rest_error():
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_expand_rest(request_type):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_expand_rest_bad_request(transport: str = 'rest', request_type=gs_echo.ExpandRequest):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_paged_expand_rest(request_type):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_paged_expand_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gs_echo.PagedExpandResponse.to_json(gs_echo.PagedExpandResponse())
...
def test_paged_expand_rest_bad_request(transport: str = 'rest', request_type=gs_echo.PagedExpandRequest):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_paged_expand_legacy_rest(request_type):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_paged_expand_legacy_rest_bad_request(transport: str = 'rest', request_type=gs_echo.PagedExpandLegacyRequest):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_paged_expand_legacy_mapped_rest(request_type):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_paged_expand_legacy_mapped_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gs_echo.PagedExpandLegacyMappedResponse.to_json(gs_echo.PagedExpandLegacyMappedResponse())
...
def test_paged_expand_legacy_mapped_rest_bad_request(transport: str = 'rest', request_type=gs_echo.PagedExpandRequest):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_wait_rest_bad_request(transport: str = 'rest', request_type=gs_echo.WaitRequest):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_block_rest(request_type):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_block_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gs_echo.BlockResponse.to_json(gs_echo.BlockResponse())
...
def test_block_rest_bad_request(transport: str = 'rest', request_type=gs_echo.BlockRequest):
    client = EchoClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_transport_kind(transport_name):
    transport = EchoClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
