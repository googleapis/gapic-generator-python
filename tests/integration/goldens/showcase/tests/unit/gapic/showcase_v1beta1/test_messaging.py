...
@pytest.mark.asyncio
async def test_create_room_rest_asyncio_bad_request(request_type=messaging.CreateRoomRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_get_room_rest_asyncio_bad_request(request_type=messaging.GetRoomRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_update_room_rest_asyncio_bad_request(request_type=messaging.UpdateRoomRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_delete_room_rest_asyncio_bad_request(request_type=messaging.DeleteRoomRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_list_rooms_rest_asyncio_error():
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_create_blurb_rest_asyncio_bad_request(request_type=messaging.CreateBlurbRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_get_blurb_rest_asyncio_bad_request(request_type=messaging.GetBlurbRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_update_blurb_rest_asyncio_bad_request(request_type=messaging.UpdateBlurbRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_delete_blurb_rest_asyncio_bad_request(request_type=messaging.DeleteBlurbRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_list_blurbs_rest_asyncio_error():
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_search_blurbs_rest_asyncio_error():
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_stream_blurbs_rest_asyncio_bad_request(request_type=messaging.StreamBlurbsRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
