...
@pytest.mark.asyncio
async def test_create_session_rest_asyncio_bad_request(request_type=testing.CreateSessionRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_get_session_rest_asyncio_bad_request(request_type=testing.GetSessionRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_list_sessions_rest_asyncio_error():
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_delete_session_rest_asyncio_bad_request(request_type=testing.DeleteSessionRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_report_session_rest_asyncio_bad_request(request_type=testing.ReportSessionRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
async def test_report_session_rest_asyncio_call_success(request_type):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_list_tests_rest_asyncio_error():
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_delete_test_rest_asyncio_bad_request(request_type=testing.DeleteTestRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
async def test_delete_test_rest_asyncio_call_success(request_type):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_verify_test_rest_asyncio_bad_request(request_type=testing.VerifyTestRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
async def test_verify_test_rest_asyncio_call_success(request_type):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
