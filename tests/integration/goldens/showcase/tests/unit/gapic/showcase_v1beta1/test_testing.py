...
def test_report_session_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = TestingClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_list_tests_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = TestingClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_list_tests_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_tests(request={})
...
def test_delete_test_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = TestingClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_verify_test_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = TestingClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_transport_kind(transport_name):
    transport = TestingClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
