...
@pytest.mark.asyncio
async def test_create_sequence_rest_asyncio_bad_request(request_type=gs_sequence.CreateSequenceRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
async def test_create_sequence_rest_asyncio_call_success(request_type):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_create_streaming_sequence_rest_asyncio_bad_request(request_type=sequence.CreateStreamingSequenceRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
async def test_create_streaming_sequence_rest_asyncio_call_success(request_type):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_get_sequence_report_rest_asyncio_bad_request(request_type=sequence.GetSequenceReportRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
async def test_get_sequence_report_rest_asyncio_call_success(request_type):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_get_streaming_sequence_report_rest_asyncio_bad_request(request_type=sequence.GetStreamingSequenceReportRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
async def test_get_streaming_sequence_report_rest_asyncio_call_success(request_type):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_attempt_sequence_rest_asyncio_bad_request(request_type=sequence.AttemptSequenceRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
async def test_attempt_sequence_rest_asyncio_call_success(request_type):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
@pytest.mark.asyncio
async def test_attempt_streaming_sequence_rest_asyncio_bad_request(request_type=sequence.AttemptStreamingSequenceRequest):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
...
async def test_attempt_streaming_sequence_rest_asyncio_call_success(request_type):
    if not HAS_GOOGLE_AUTH_AIO:
        pytest.skip("google-auth >= 2.35.0 is required for async rest transport.")
    elif not HAS_AIOHTTP_INSTALLED:
        pytest.skip("aiohttp is required for async rest transport.")
