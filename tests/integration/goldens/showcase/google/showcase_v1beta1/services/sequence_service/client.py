...
from .transports.grpc import SequenceServiceGrpcTransport
from .transports.grpc_asyncio import SequenceServiceGrpcAsyncIOTransport
from .transports.rest import SequenceServiceRestTransport
try:
    from .transports.rest_asyncio import AsyncSequenceServiceRestTransport
...
class SequenceServiceClientMeta(type):
    """Metaclass for the SequenceService client.
    ...
    if HAS_ASYNC_REST_DEPENDENCIES:  # pragma: NO COVER
        _transport_registry["rest_asyncio"] = AsyncSequenceServiceRestTransport

    def get_transport_class(cls,
            label: Optional[str] = None,
        ) -> Type[SequenceServiceTransport]:
...
class SequenceServiceClient(metaclass=SequenceServiceClientMeta):
    """"""
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            SequenceServiceClient: The constructed client.
        """
    ...
    def transport(self) -> SequenceServiceTransport:
        ...
        Returns:
            SequenceServiceTransport: The transport used by the client
                instance.
        """
    ...
    def sequence_path(sequence: str,) -> str:
        ...
        return "sequences/{sequence}".format(sequence=sequence, )

    @staticmethod
    def parse_sequence_path(path: str) -> Dict[str,str]:
        """Parses a sequence path into its component segments."""
        m = re.match(r"^sequences/(?P<sequence>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def sequence_report_path(sequence: str,) -> str:
        """Returns a fully-qualified sequence_report string."""
        return "sequences/{sequence}/sequenceReport".format(sequence=sequence, )

    @staticmethod
    def parse_sequence_report_path(path: str) -> Dict[str,str]:
        """Parses a sequence_report path into its component segments."""
        m = re.match(r"^sequences/(?P<sequence>.+?)/sequenceReport$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def streaming_sequence_path(streaming_sequence: str,) -> str:
        """Returns a fully-qualified streaming_sequence string."""
        return "streamingSequences/{streaming_sequence}".format(streaming_sequence=streaming_sequence, )

    @staticmethod
    def parse_streaming_sequence_path(path: str) -> Dict[str,str]:
        """Parses a streaming_sequence path into its component segments."""
        m = re.match(r"^streamingSequences/(?P<streaming_sequence>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def streaming_sequence_report_path(streaming_sequence: str,) -> str:
        """Returns a fully-qualified streaming_sequence_report string."""
        return "streamingSequences/{streaming_sequence}/streamingSequenceReport".format(streaming_sequence=streaming_sequence, )

    @staticmethod
    def parse_streaming_sequence_report_path(path: str) -> Dict[str,str]:
        """Parses a streaming_sequence_report path into its component segments."""
        m = re.match(r"^streamingSequences/(?P<streaming_sequence>.+?)/streamingSequenceReport$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = SequenceServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = SequenceServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = SequenceServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            SequenceServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, SequenceServiceTransport, Callable[..., SequenceServiceTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the sequence service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SequenceServiceClient._read_environment_variables()
        self._client_cert_source = SequenceServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SequenceServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, SequenceServiceTransport)
        if transport_provided:
            # transport is a SequenceServiceTransport instance.
            ...
            self._transport = cast(SequenceServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            SequenceServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            transport_init: Union[Type[SequenceServiceTransport], Callable[..., SequenceServiceTransport]] = (
                SequenceServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., SequenceServiceTransport], transport)
            )
    ...
    def create_sequence(self,
        ...
        has_flattened_params = any([sequence])
    ...
    def create_streaming_sequence(self,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        has_flattened_params = any([streaming_sequence])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_streaming_sequence]
    ...
    def get_sequence_report(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_sequence_report]
    ...
    def get_streaming_sequence_report(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_streaming_sequence_report]
    ...
    def attempt_sequence(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.attempt_sequence]
    ...
    def attempt_streaming_sequence(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> Iterable[sequence.AttemptStreamingSequenceResponse]:
        r"""Attempts a streaming sequence.
        ...
        Returns:
            Iterable[google.showcase_v1beta1.types.AttemptStreamingSequenceResponse]:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.attempt_streaming_sequence]
    ...
    def __enter__(self) -> "SequenceServiceClient":
        return self
