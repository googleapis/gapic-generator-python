...
from .base import SequenceServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class SequenceServiceRestTransport(SequenceServiceTransport):
    """REST backend transport for SequenceService.
    ...
    class _AttemptSequence(SequenceServiceRestStub):
        def __hash__(self):
            return hash("AttemptSequence")
        ...
        def __call__(self,
            ...
            pb_request = sequence.AttemptSequenceRequest.pb(request)
    ...
    class _AttemptStreamingSequence(SequenceServiceRestStub):
        def __hash__(self):
            return hash("AttemptStreamingSequence")
        ...
        sequence method over HTTP.
            ...
            pb_request = sequence.AttemptStreamingSequenceRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _CreateSequence(SequenceServiceRestStub):
        def __hash__(self):
            return hash("CreateSequence")
        ...
        def __call__(self,
            ...
            pb_request = gs_sequence.CreateSequenceRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _CreateStreamingSequence(SequenceServiceRestStub):
        def __hash__(self):
            return hash("CreateStreamingSequence")
        ...
        def __call__(self,
            ...
            pb_request = sequence.CreateStreamingSequenceRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _GetSequenceReport(SequenceServiceRestStub):
        def __hash__(self):
            return hash("GetSequenceReport")
        ...
        def __call__(self,
            ...
            pb_request = sequence.GetSequenceReportRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _GetStreamingSequenceReport(SequenceServiceRestStub):
        def __hash__(self):
            return hash("GetStreamingSequenceReport")
        ...
        report method over HTTP.
            ...
            pb_request = sequence.GetStreamingSequenceReportRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ListLocations(SequenceServiceRestStub):
        def __call__(self,
    ...
    class _GetLocation(SequenceServiceRestStub):
        def __call__(self,
    ...
    class _SetIamPolicy(SequenceServiceRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _GetIamPolicy(SequenceServiceRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _TestIamPermissions(SequenceServiceRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _ListOperations(SequenceServiceRestStub):
        def __call__(self,
    ...
    class _GetOperation(SequenceServiceRestStub):
        def __call__(self,
    ...
    class _DeleteOperation(SequenceServiceRestStub):
        def __call__(self,
    ...
    class _CancelOperation(SequenceServiceRestStub):
        def __call__(self,
