...
class SequenceServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return SequenceServiceClient.from_service_account_info.__func__(SequenceServiceAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            SequenceServiceAsyncClient: The constructed client.
        """
        return SequenceServiceClient.from_service_account_file.__func__(SequenceServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    get_transport_class = functools.partial(type(SequenceServiceClient).get_transport_class, type(SequenceServiceClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Union[str, SequenceServiceTransport] = "grpc_asyncio",
    ...
    async def create_streaming_sequence(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.create_streaming_sequence,
            default_timeout=None,
            client_info=DEFAULT_CLIENT_INFO,
        )
    ...
    async def get_sequence_report(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.get_sequence_report,
            default_timeout=None,
            client_info=DEFAULT_CLIENT_INFO,
        )
    ...
    async def get_streaming_sequence_report(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.get_streaming_sequence_report,
            default_timeout=None,
            client_info=DEFAULT_CLIENT_INFO,
        )
    ...
    async def attempt_sequence(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.attempt_sequence,
            default_retry=retries.AsyncRetry(
initial=0.1,maximum=3.0,multiplier=2,                predicate=retries.if_exception_type(
    ...
    def attempt_streaming_sequence(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.attempt_streaming_sequence,
            default_timeout=None,
            client_info=DEFAULT_CLIENT_INFO,
        )
