...
class IdentityClient(metaclass=IdentityClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            IdentityClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, IdentityTransport]] = None,
    ...
    def create_user(self,
        ...
        # in a identity.CreateUserRequest.
    ...
    def update_user(self,
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a identity.UpdateUserRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_user(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a identity.DeleteUserRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_users(self,
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a identity.ListUsersRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
