...
from .base import IdentityTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class IdentityRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_user(self, request: identity.CreateUserRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[identity.CreateUserRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_create_user(self, response: identity.User) -> identity.User:
        ...
        """
        return response
    def pre_delete_user(self, request: identity.DeleteUserRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[identity.DeleteUserRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_user(self, request: identity.GetUserRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[identity.GetUserRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_user(self, response: identity.User) -> identity.User:
        ...
        """
        return response
    def pre_list_users(self, request: identity.ListUsersRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[identity.ListUsersRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_users(self, response: identity.ListUsersResponse) -> identity.ListUsersResponse:
        ...
        """
        return response
    def pre_update_user(self, request: identity.UpdateUserRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[identity.UpdateUserRequest, Sequence[Tuple[str, str]]]:
...
class IdentityRestTransport(IdentityTransport):
    """REST backend transport for Identity.
    ...
    class _CreateUser(IdentityRestStub):
        def __hash__(self):
    ...
    class _DeleteUser(IdentityRestStub):
        def __hash__(self):
    ...
    class _GetUser(IdentityRestStub):
        def __hash__(self):
            return hash("GetUser")
    ...
    class _ListUsers(IdentityRestStub):
        def __hash__(self):
    ...
    class _UpdateUser(IdentityRestStub):
        def __hash__(self):
    ...
    class _ListLocations(IdentityRestStub):
        def __call__(self,
    ...
    class _GetLocation(IdentityRestStub):
        def __call__(self,
    ...
    class _SetIamPolicy(IdentityRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _GetIamPolicy(IdentityRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _TestIamPermissions(IdentityRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _ListOperations(IdentityRestStub):
        def __call__(self,
    ...
    class _GetOperation(IdentityRestStub):
        def __call__(self,
    ...
    class _DeleteOperation(IdentityRestStub):
        def __call__(self,
    ...
    class _CancelOperation(IdentityRestStub):
        def __call__(self,
