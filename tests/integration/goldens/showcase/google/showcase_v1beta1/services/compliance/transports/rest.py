...
class ComplianceRestTransport(_BaseComplianceRestTransport):
    ...
    class _ListLocations(_BaseComplianceRestTransport._BaseListLocations, ComplianceRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseComplianceRestTransport._BaseListLocations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseComplianceRestTransport._BaseListLocations._get_query_params_json(transcoded_request)
    ...
    class _GetLocation(_BaseComplianceRestTransport._BaseGetLocation, ComplianceRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseComplianceRestTransport._BaseGetLocation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseComplianceRestTransport._BaseGetLocation._get_query_params_json(transcoded_request)
    ...
    class _SetIamPolicy(_BaseComplianceRestTransport._BaseSetIamPolicy, ComplianceRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseComplianceRestTransport._BaseSetIamPolicy._get_transcoded_request(http_options, request)

            body = _BaseComplianceRestTransport._BaseSetIamPolicy._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseComplianceRestTransport._BaseSetIamPolicy._get_query_params_json(transcoded_request)
    ...
    class _GetIamPolicy(_BaseComplianceRestTransport._BaseGetIamPolicy, ComplianceRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseComplianceRestTransport._BaseGetIamPolicy._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseComplianceRestTransport._BaseGetIamPolicy._get_query_params_json(transcoded_request)
    ...
    class _TestIamPermissions(_BaseComplianceRestTransport._BaseTestIamPermissions, ComplianceRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseComplianceRestTransport._BaseTestIamPermissions._get_transcoded_request(http_options, request)

            body = _BaseComplianceRestTransport._BaseTestIamPermissions._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseComplianceRestTransport._BaseTestIamPermissions._get_query_params_json(transcoded_request)
    ...
    class _ListOperations(_BaseComplianceRestTransport._BaseListOperations, ComplianceRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseComplianceRestTransport._BaseListOperations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseComplianceRestTransport._BaseListOperations._get_query_params_json(transcoded_request)
    ...
    class _GetOperation(_BaseComplianceRestTransport._BaseGetOperation, ComplianceRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseComplianceRestTransport._BaseGetOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseComplianceRestTransport._BaseGetOperation._get_query_params_json(transcoded_request)
    ...
    class _DeleteOperation(_BaseComplianceRestTransport._BaseDeleteOperation, ComplianceRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseComplianceRestTransport._BaseDeleteOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseComplianceRestTransport._BaseDeleteOperation._get_query_params_json(transcoded_request)
    ...
    class _CancelOperation(_BaseComplianceRestTransport._BaseCancelOperation, ComplianceRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseComplianceRestTransport._BaseCancelOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseComplianceRestTransport._BaseCancelOperation._get_query_params_json(transcoded_request)
