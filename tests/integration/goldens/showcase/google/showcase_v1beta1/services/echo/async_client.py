...
class EchoAsyncClient:
    ...
    get_transport_class = functools.partial(type(EchoClient).get_transport_class, type(EchoClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Union[str, EchoTransport] = "grpc_asyncio",
...
initial=0.1,maximum=3.0,multiplier=2,                predicate=retries.if_exception_type(
    ...
    async def echo_error_details(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.echo_error_details,
    ...
    def expand(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.expand,
            default_retry=retries.AsyncRetry(
initial=0.1,maximum=3.0,multiplier=2,                predicate=retries.if_exception_type(
                    core_exceptions.ServiceUnavailable,
                    core_exceptions.Unknown,
    ...
    async def collect(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.collect,
            default_timeout=None,
            client_info=DEFAULT_CLIENT_INFO,
        )
    ...
    async def paged_expand(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.paged_expand,
            default_retry=retries.AsyncRetry(
initial=0.1,maximum=3.0,multiplier=2,                predicate=retries.if_exception_type(
                    core_exceptions.ServiceUnavailable,
                    core_exceptions.Unknown,
    ...
    async def paged_expand_legacy(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.paged_expand_legacy,
            default_timeout=None,
            client_info=DEFAULT_CLIENT_INFO,
        )
    ...
    async def paged_expand_legacy_mapped(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.paged_expand_legacy_mapped,
            default_timeout=None,
            client_info=DEFAULT_CLIENT_INFO,
        )
