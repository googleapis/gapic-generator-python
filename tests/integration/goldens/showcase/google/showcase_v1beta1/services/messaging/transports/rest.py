...
from .base import MessagingTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class MessagingRestTransport(MessagingTransport):
    """REST backend transport for Messaging.
    ...
    class _Connect(MessagingRestStub):
        def __hash__(self):
            return hash("Connect")
    ...
    class _CreateBlurb(MessagingRestStub):
        def __hash__(self):
            return hash("CreateBlurb")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta1/{parent=rooms/*}/blurbs',
                'body': '*',
            },
{
                'method': 'post',
                'uri': '/v1beta1/{parent=users/*/profile}/blurbs',
                'body': '*',
            },
            ]
            request, metadata = self._interceptor.pre_create_blurb(request, metadata)
            pb_request = messaging.CreateBlurbRequest.pb(request)
    ...
    class _CreateRoom(MessagingRestStub):
        def __hash__(self):
            return hash("CreateRoom")
        ...
        def __call__(self,
            ...
            pb_request = messaging.CreateRoomRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _DeleteBlurb(MessagingRestStub):
        def __hash__(self):
            return hash("DeleteBlurb")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1beta1/{name=rooms/*/blurbs/*}',
            },
{
                'method': 'delete',
                'uri': '/v1beta1/{name=users/*/profile/blurbs/*}',
            },
            ]
            request, metadata = self._interceptor.pre_delete_blurb(request, metadata)
            pb_request = messaging.DeleteBlurbRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _DeleteRoom(MessagingRestStub):
        def __hash__(self):
            return hash("DeleteRoom")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1beta1/{name=rooms/*}',
            },
            ]
            request, metadata = self._interceptor.pre_delete_room(request, metadata)
            pb_request = messaging.DeleteRoomRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _GetBlurb(MessagingRestStub):
        def __hash__(self):
            return hash("GetBlurb")
            ...
            },
{
            ...
            pb_request = messaging.GetBlurbRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _GetRoom(MessagingRestStub):
        def __hash__(self):
            return hash("GetRoom")
        ...
        def __call__(self,
            ...
            pb_request = messaging.GetRoomRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ListBlurbs(MessagingRestStub):
        def __hash__(self):
            return hash("ListBlurbs")
            ...
            },
{
            ...
            pb_request = messaging.ListBlurbsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ListRooms(MessagingRestStub):
        def __hash__(self):
            return hash("ListRooms")
        ...
        def __call__(self,
            ...
            pb_request = messaging.ListRoomsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _SearchBlurbs(MessagingRestStub):
        def __hash__(self):
            return hash("SearchBlurbs")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta1/{parent=rooms/*}/blurbs:search',
                'body': '*',
            },
{
                'method': 'post',
                'uri': '/v1beta1/{parent=users/*/profile}/blurbs:search',
            },
            ]
            request, metadata = self._interceptor.pre_search_blurbs(request, metadata)
            pb_request = messaging.SearchBlurbsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _SendBlurbs(MessagingRestStub):
        def __hash__(self):
            return hash("SendBlurbs")
    ...
    class _StreamBlurbs(MessagingRestStub):
        def __hash__(self):
            return hash("StreamBlurbs")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta1/{name=rooms/*}/blurbs:stream',
                'body': '*',
            },
{
                'method': 'post',
                'uri': '/v1beta1/{name=users/*/profile}/blurbs:stream',
                'body': '*',
            },
            ]
            request, metadata = self._interceptor.pre_stream_blurbs(request, metadata)
            pb_request = messaging.StreamBlurbsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _UpdateBlurb(MessagingRestStub):
        def __hash__(self):
            return hash("UpdateBlurb")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1beta1/{blurb.name=rooms/*/blurbs/*}',
                'body': 'blurb',
            },
{
                'method': 'patch',
                'uri': '/v1beta1/{blurb.name=users/*/profile/blurbs/*}',
                'body': 'blurb',
            },
            ]
            request, metadata = self._interceptor.pre_update_blurb(request, metadata)
            pb_request = messaging.UpdateBlurbRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _UpdateRoom(MessagingRestStub):
        def __hash__(self):
            return hash("UpdateRoom")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1beta1/{room.name=rooms/*}',
                'body': 'room',
            },
            ]
            request, metadata = self._interceptor.pre_update_room(request, metadata)
            pb_request = messaging.UpdateRoomRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ListLocations(MessagingRestStub):
        def __call__(self,
    ...
    class _GetLocation(MessagingRestStub):
        def __call__(self,
    ...
    class _SetIamPolicy(MessagingRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _GetIamPolicy(MessagingRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _TestIamPermissions(MessagingRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _ListOperations(MessagingRestStub):
        def __call__(self,
    ...
    class _GetOperation(MessagingRestStub):
        def __call__(self,
    ...
    class _DeleteOperation(MessagingRestStub):
        def __call__(self,
    ...
    class _CancelOperation(MessagingRestStub):
        def __call__(self,
