...
class MessagingAsyncClient:
    ...
    get_transport_class = functools.partial(type(MessagingClient).get_transport_class, type(MessagingClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Union[str, MessagingTransport] = "grpc_asyncio",
    ...
    async def create_room(self,
        ...
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.create_room,
...
initial=0.1,maximum=3.0,multiplier=2,                predicate=retries.if_exception_type(
    ...
    async def update_room(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.update_room,
            default_timeout=None,
            client_info=DEFAULT_CLIENT_INFO,
        )
    ...
    async def delete_room(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.delete_room,
            default_timeout=None,
            client_info=DEFAULT_CLIENT_INFO,
        )
...
initial=0.1,maximum=3.0,multiplier=2,                predicate=retries.if_exception_type(
    ...
    async def create_blurb(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.create_blurb,
            default_timeout=None,
            client_info=DEFAULT_CLIENT_INFO,
        )
    ...
    async def get_blurb(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.get_blurb,
            default_retry=retries.AsyncRetry(
initial=0.1,maximum=3.0,multiplier=2,                predicate=retries.if_exception_type(
                    core_exceptions.ServiceUnavailable,
                    core_exceptions.Unknown,
    ...
    async def update_blurb(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.update_blurb,
            default_timeout=None,
            client_info=DEFAULT_CLIENT_INFO,
        )
    ...
    async def delete_blurb(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.delete_blurb,
            default_timeout=None,
            client_info=DEFAULT_CLIENT_INFO,
        )
    ...
    async def list_blurbs(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.list_blurbs,
            default_retry=retries.AsyncRetry(
initial=0.1,maximum=3.0,multiplier=2,                predicate=retries.if_exception_type(
                    core_exceptions.ServiceUnavailable,
                    core_exceptions.Unknown,
    ...
    async def search_blurbs(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.search_blurbs,
            default_retry=retries.AsyncRetry(
initial=0.1,maximum=3.0,multiplier=2,                predicate=retries.if_exception_type(
                    core_exceptions.ServiceUnavailable,
                    core_exceptions.Unknown,
    ...
    def stream_blurbs(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.stream_blurbs,
            default_timeout=None,
            client_info=DEFAULT_CLIENT_INFO,
        )
    ...
    async def send_blurbs(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.send_blurbs,
            default_timeout=None,
            client_info=DEFAULT_CLIENT_INFO,
        )
    ...
    def connect(self,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.connect,
            default_retry=retries.AsyncRetry(
initial=0.1,maximum=3.0,multiplier=2,                predicate=retries.if_exception_type(
                    core_exceptions.ServiceUnavailable,
                    core_exceptions.Unknown,
