...
class IAMCredentialsRestTransport(_BaseIAMCredentialsRestTransport):
    ...
    def generate_access_token(
        self
    ) -> Callable[[common.GenerateAccessTokenRequest], common.GenerateAccessTokenResponse]:
    ...
    def sign_blob(
        self
    ) -> Callable[[common.SignBlobRequest], common.SignBlobResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def sign_jwt(
        self
    ) -> Callable[[common.SignJwtRequest], common.SignJwtResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
