...
def test_generate_access_token_routing_header_override():
    client = IAMCredentialsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        client.generate_access_token(request, metadata=override)
...
def test_generate_id_token_routing_header_override():
    client = IAMCredentialsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        custom_val = "key=custom"
        override = [('x-goog-request-params', custom_val)]
        client.generate_id_token(request, metadata=override)
...
def test_sign_blob_routing_header_override():
    client = IAMCredentialsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        custom_val = "key=custom"
        override = [('x-goog-request-params', custom_val)]
        client.sign_blob(request, metadata=override)
...
def test_sign_jwt_routing_header_override():
    client = IAMCredentialsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        custom_val = "key=custom"
        override = [('x-goog-request-params', custom_val)]
        client.sign_jwt(request, metadata=override)
