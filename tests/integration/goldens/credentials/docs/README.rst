...
`IAM Service Account Credentials API`_: Creates short-lived, limited-privilege credentials for IAM service accounts.
...
.. _samples/: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-iam-credentials/samples
...
.. code-block:: console
    ...
    pip install google-iam-credentials
