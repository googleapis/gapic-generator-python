...
class EventarcClient(metaclass=EventarcClientMeta):
    ...
    @staticmethod
    def parse_channel_connection_path(
        path: str,
    ) -> Dict[str, str]:
    ...
    @staticmethod
    def parse_google_channel_config_path(
        path: str,
    ) -> Dict[str, str]:
    ...
    @staticmethod
    def parse_service_account_path(
        path: str,
    ) -> Dict[str, str]:
