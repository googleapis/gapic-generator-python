...
class ListMessageBusesRequest(proto.Message):
    ...
    Attributes:
        ...
        page_size (int):
            ...
            Note: The service may send fewer.
        page_token (str):
            Optional. The page token; provide the value
            from the `next_page_token` field in a previous
            call to retrieve the subsequent page.

            When paginating, all other parameters provided
            must match the previous call that provided the
            page token.
        order_by (str):
            Optional. The sorting order of the resources
            returned. Value should be a comma-separated list
            of fields. The default sorting order is
            ascending. To specify descending order for a
            field, append a `desc` suffix; for example:
...
class ListMessageBusesResponse(proto.Message):
    ...
    Attributes:
        message_buses (MutableSequence[google.cloud.eventarc_v1.types.MessageBus]):
            The requested message buses, up to the number
            specified in `page_size`.
        next_page_token (str):
            A page token that can be sent to
            `ListMessageBuses` to request the next page. If
            this is empty, then there are no more pages.
        unreachable (MutableSequence[str]):
            Unreachable resources, if any.
    """
...
class ListMessageBusEnrollmentsRequest(proto.Message):
    r"""The request message for the `ListMessageBusEnrollments`
    method.
...
class ListMessageBusEnrollmentsResponse(proto.Message):
    r"""The response message for the `ListMessageBusEnrollments`
    method.`

    Attributes:
        enrollments (MutableSequence[str]):
            The requested enrollments, up to the number
            specified in `page_size`.
        next_page_token (str):
            A page token that can be sent to
            `ListMessageBusEnrollments` to request the next
            page. If this is empty, then there are no more
            pages.
        unreachable (MutableSequence[str]):
            Unreachable resources, if any.
...
class UpdateMessageBusRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            Optional. The fields to be updated; only
            fields explicitly provided are updated. If no
            field mask is provided, all provided fields in
            the request are updated. To update all fields,
            provide a field mask of "*".
        allow_missing (bool):
            Optional. If set to true, and the MessageBus
            is not found, a new MessageBus will be created.
...
class ListEnrollmentsResponse(proto.Message):
    ...
    Attributes:
        ...
        next_page_token (str):
            A page token that can be sent to
            `ListEnrollments` to request the next page. If
            this is empty, then there are no more pages.
        unreachable (MutableSequence[str]):
            Unreachable resources, if any.
    """
...
class UpdateEnrollmentRequest(proto.Message):
    ...
    Attributes:
        ...
        allow_missing (bool):
            ...
            is not found, a new Enrollment will be created.
            In this situation, `update_mask` is ignored.
        validate_only (bool):
            Optional. If set, validate the request and
            preview the review, but do not post it.
...
class ListPipelinesResponse(proto.Message):
    ...
    Attributes:
        pipelines (MutableSequence[google.cloud.eventarc_v1.types.Pipeline]):
            The requested pipelines, up to the number
            specified in `page_size`.
        next_page_token (str):
            A page token that can be sent to
            `ListPipelines` to request the next page. If
            this is empty, then there are no more pages.
        unreachable (MutableSequence[str]):
            Unreachable resources, if any.
    """
...
class CreatePipelineRequest(proto.Message):
    ...
    Attributes:
        ...
        pipeline_id (str):
            Required. The user-provided ID to be assigned
            to the Pipeline. It should match the format
            `^[a-z]([a-z0-9-]{0,61}[a-z0-9])?$`.
        validate_only (bool):
            Optional. If set, validate the request and
            preview the review, but do not post it.
...
class UpdatePipelineRequest(proto.Message):
    ...
    Attributes:
        ...
        allow_missing (bool):
            ...
            not found, a new Pipeline will be created. In
...
class ListGoogleApiSourcesResponse(proto.Message):
    ...
    Attributes:
        google_api_sources (MutableSequence[google.cloud.eventarc_v1.types.GoogleApiSource]):
            The requested GoogleApiSources, up to the
            number specified in `page_size`.
        next_page_token (str):
            A page token that can be sent to
            `ListMessageBusEnrollments` to request the next
...
class CreateGoogleApiSourceRequest(proto.Message):
    ...
    Attributes:
        ...
        google_api_source_id (str):
            Required. The user-provided ID to be assigned
            to the GoogleApiSource. It should match the
...
class UpdateGoogleApiSourceRequest(proto.Message):
    ...
    Attributes:
        ...
        allow_missing (bool):
            ...
            GoogleApiSource is not found, a new
            GoogleApiSource will be created. In this
            situation, `update_mask` is ignored.
        validate_only (bool):
            Optional. If set, validate the request and
            preview the review, but do not post it.
