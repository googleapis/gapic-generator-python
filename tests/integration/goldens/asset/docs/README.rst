...
`Cloud Asset API`_: The Cloud Asset API manages the history and inventory of Google Cloud resources.
...
.. _Client Library Documentation: https://cloud.google.com/python/docs/reference/asset/latest/summary_overview
