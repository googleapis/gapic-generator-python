...
@mock.patch.object(AssetServiceClient, "DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AssetServiceClient))
...
def test__get_api_endpoint():
    ...
    mock_endpoint = AssetServiceClient.DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)
...
def test__validate_universe_domain():
    ...
    client = AssetServiceClient(lient_options=client_options.ClientOptions(universe_domain="foo.com"), credentials=AnonymousCredentialsWithUniverseDomain())
    with pytest.raises(ValueError) as excinfo:
...
def test_export_assets_rest_required_fields(request_type=asset_service.ExportAssetsRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).export_assets._get_unset_required_fields(jsonified_request)
...
def test_export_assets_rest_unset_required_fields():
    transport = transports.AssetServiceRestTransport(credentials=AnonymousCredentialsWithUniverseDomain)
...
def test_list_assets_rest_required_fields(request_type=asset_service.ListAssetsRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).list_assets._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_get_assets_history_rest_required_fields(request_type=asset_service.BatchGetAssetsHistoryRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).batch_get_assets_history._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_feed_rest_required_fields(request_type=asset_service.CreateFeedRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).create_feed._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_feed_rest_required_fields(request_type=asset_service.GetFeedRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).get_feed._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_feeds_rest_required_fields(request_type=asset_service.ListFeedsRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).list_feeds._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_feed_rest_required_fields(request_type=asset_service.UpdateFeedRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).update_feed._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_feed_rest_required_fields(request_type=asset_service.DeleteFeedRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).delete_feed._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_search_all_resources_rest_required_fields(request_type=asset_service.SearchAllResourcesRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).search_all_resources._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_search_all_iam_policies_rest_required_fields(request_type=asset_service.SearchAllIamPoliciesRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).search_all_iam_policies._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_analyze_iam_policy_rest_required_fields(request_type=asset_service.AnalyzeIamPolicyRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).analyze_iam_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_analyze_iam_policy_longrunning_rest_required_fields(request_type=asset_service.AnalyzeIamPolicyLongrunningRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).analyze_iam_policy_longrunning._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_analyze_move_rest_required_fields(request_type=asset_service.AnalyzeMoveRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).analyze_move._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_query_assets_rest_required_fields(request_type=asset_service.QueryAssetsRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).query_assets._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_saved_query_rest_required_fields(request_type=asset_service.CreateSavedQueryRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).create_saved_query._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_saved_query_rest_required_fields(request_type=asset_service.GetSavedQueryRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).get_saved_query._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_saved_queries_rest_required_fields(request_type=asset_service.ListSavedQueriesRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).list_saved_queries._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_saved_query_rest_required_fields(request_type=asset_service.UpdateSavedQueryRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).update_saved_query._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_saved_query_rest_required_fields(request_type=asset_service.DeleteSavedQueryRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).delete_saved_query._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_get_effective_iam_policies_rest_required_fields(request_type=asset_service.BatchGetEffectiveIamPoliciesRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).batch_get_effective_iam_policies._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_analyze_org_policies_rest_required_fields(request_type=asset_service.AnalyzeOrgPoliciesRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).analyze_org_policies._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_analyze_org_policy_governed_containers_rest_required_fields(request_type=asset_service.AnalyzeOrgPolicyGovernedContainersRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).analyze_org_policy_governed_containers._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_analyze_org_policy_governed_assets_rest_required_fields(request_type=asset_service.AnalyzeOrgPolicyGovernedAssetsRequest):
    ...
    unset_fields = transport_class(credentials=AnonymousCredentialsWithUniverseDomain()).analyze_org_policy_governed_assets._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
