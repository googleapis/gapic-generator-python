...
class AssetServiceAsyncClient:
    ...
    async def export_assets(self,
        ...
        Args:
            request (Union[google.cloud.asset_v1.types.ExportAssetsRequest, dict, None]):
    ...
    async def list_assets(self,
        ...
        Args:
            request (Union[google.cloud.asset_v1.types.ListAssetsRequest, dict, None]):
    ...
    async def batch_get_assets_history(self,
        ...
        Args:
            request (Union[google.cloud.asset_v1.types.BatchGetAssetsHistoryRequest, dict, None]):
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def create_feed(self,
        ...
        Args:
            request (Union[google.cloud.asset_v1.types.CreateFeedRequest, dict, None]):
    ...
    async def get_feed(self,
        ...
        Args:
            request (Union[google.cloud.asset_v1.types.GetFeedRequest, dict, None]):
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def list_feeds(self,
        ...
        Args:
            request (Union[google.cloud.asset_v1.types.ListFeedsRequest, dict, None]):
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def update_feed(self,
        ...
        Args:
            request (Union[google.cloud.asset_v1.types.UpdateFeedRequest, dict, None]):
    ...
    async def delete_feed(self,
        ...
        Args:
            request (Union[google.cloud.asset_v1.types.DeleteFeedRequest, dict, None]):
                The request object.
            name (:class:`str`):
                Required. The name of the feed and it must be in the
                format of: projects/project_number/feeds/feed_id
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def search_all_resources(self,
        ...
        Args:
            request (Union[google.cloud.asset_v1.types.SearchAllResourcesRequest, dict, None]):
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def search_all_iam_policies(self,
        ...
        Args:
            request (Union[google.cloud.asset_v1.types.SearchAllIamPoliciesRequest, dict, None]):
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def analyze_iam_policy(self,
        ...
        Args:
            request (Union[google.cloud.asset_v1.types.AnalyzeIamPolicyRequest, dict, None]):
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def analyze_iam_policy_longrunning(self,
        ...
        Args:
            request (Union[google.cloud.asset_v1.types.AnalyzeIamPolicyLongrunningRequest, dict, None]):
                The request object. A request message for
