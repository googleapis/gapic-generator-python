...
class AssetServiceGrpcAsyncIOTransport(AssetServiceTransport):
    ...
    def export_assets(
        self,
    ) -> Callable[[asset_service.ExportAssetsRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def list_assets(
        self,
    ) -> Callable[[asset_service.ListAssetsRequest], Awaitable[asset_service.ListAssetsResponse]]:
    ...
    def list_feeds(
        self,
    ) -> Callable[[asset_service.ListFeedsRequest], Awaitable[asset_service.ListFeedsResponse]]:
    ...
    def search_all_resources(
        self,
    ) -> Callable[[asset_service.SearchAllResourcesRequest], Awaitable[asset_service.SearchAllResourcesResponse]]:
    ...
    def search_all_iam_policies(
        self,
    ) -> Callable[[asset_service.SearchAllIamPoliciesRequest], Awaitable[asset_service.SearchAllIamPoliciesResponse]]:
    ...
    def analyze_iam_policy(
        self,
    ) -> Callable[[asset_service.AnalyzeIamPolicyRequest], Awaitable[asset_service.AnalyzeIamPolicyResponse]]:
    ...
    def analyze_iam_policy_longrunning(
        self,
    ) -> Callable[[asset_service.AnalyzeIamPolicyLongrunningRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def analyze_move(
        self,
    ) -> Callable[[asset_service.AnalyzeMoveRequest], Awaitable[asset_service.AnalyzeMoveResponse]]:
    ...
    def query_assets(
        self,
    ) -> Callable[[asset_service.QueryAssetsRequest], Awaitable[asset_service.QueryAssetsResponse]]:
    ...
    def create_saved_query(
        self,
    ) -> Callable[[asset_service.CreateSavedQueryRequest], Awaitable[asset_service.SavedQuery]]:
    ...
    def get_saved_query(
        self,
    ) -> Callable[[asset_service.GetSavedQueryRequest], Awaitable[asset_service.SavedQuery]]:
    ...
    def list_saved_queries(
        self,
    ) -> Callable[[asset_service.ListSavedQueriesRequest], Awaitable[asset_service.ListSavedQueriesResponse]]:
    ...
    def update_saved_query(
        self,
    ) -> Callable[[asset_service.UpdateSavedQueryRequest], Awaitable[asset_service.SavedQuery]]:
    ...
    def analyze_org_policies(
        self,
    ) -> Callable[[asset_service.AnalyzeOrgPoliciesRequest], Awaitable[asset_service.AnalyzeOrgPoliciesResponse]]:
