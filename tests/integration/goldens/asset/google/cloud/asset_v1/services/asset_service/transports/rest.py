...
class AssetServiceRestTransport(_BaseAssetServiceRestTransport):
    ...
    class _AnalyzeIamPolicyLongrunning(_BaseAssetServiceRestTransport._BaseAnalyzeIamPolicyLongrunning, AssetServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the analyze iam policy longrunning method over HTTP.
    ...
    class _AnalyzeOrgPolicyGovernedAssets(_BaseAssetServiceRestTransport._BaseAnalyzeOrgPolicyGovernedAssets, AssetServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the analyze org policy governed assets method over HTTP.
    ...
    class _AnalyzeOrgPolicyGovernedContainers(_BaseAssetServiceRestTransport._BaseAnalyzeOrgPolicyGovernedContainers, AssetServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the analyze org policy governed containers method over HTTP.
    ...
    class _BatchGetEffectiveIamPolicies(_BaseAssetServiceRestTransport._BaseBatchGetEffectiveIamPolicies, AssetServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the batch get effective iam policies method over HTTP.
    ...
    def analyze_iam_policy(
        self
    ) -> Callable[[asset_service.AnalyzeIamPolicyRequest], asset_service.AnalyzeIamPolicyResponse]:
    ...
    def analyze_iam_policy_longrunning(
        self
    ) -> Callable[[asset_service.AnalyzeIamPolicyLongrunningRequest], operations_pb2.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def analyze_move(
        self
    ) -> Callable[[asset_service.AnalyzeMoveRequest], asset_service.AnalyzeMoveResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def analyze_org_policies(
        self
    ) -> Callable[[asset_service.AnalyzeOrgPoliciesRequest], asset_service.AnalyzeOrgPoliciesResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def batch_get_assets_history(
        self
    ) -> Callable[[asset_service.BatchGetAssetsHistoryRequest], asset_service.BatchGetAssetsHistoryResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def get_feed(
        self
    ) -> Callable[[asset_service.GetFeedRequest], asset_service.Feed]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def list_saved_queries(
        self
    ) -> Callable[[asset_service.ListSavedQueriesRequest], asset_service.ListSavedQueriesResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def query_assets(
        self
    ) -> Callable[[asset_service.QueryAssetsRequest], asset_service.QueryAssetsResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def search_all_iam_policies(
        self
    ) -> Callable[[asset_service.SearchAllIamPoliciesRequest], asset_service.SearchAllIamPoliciesResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def search_all_resources(
        self
    ) -> Callable[[asset_service.SearchAllResourcesRequest], asset_service.SearchAllResourcesResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
