...
class Asset(proto.Message):
    ...
    Attributes:
        ...
        service_perimeter (google.identity.accesscontextmanager.v1.service_perimeter_pb2.ServicePerimeter):
            Please also refer to the [service perimeter
            user
...
class ResourceSearchResult(proto.Message):
    ...
    Attributes:
        ...
        kms_key (str):
            ...
            backward compatibility. Please use the
            `kms_keys` field to retrieve Cloud KMS key
            information. This field is available only when
            the resource's Protobuf contains it and will
...
class IamPolicySearchResult(proto.Message):
    ...
    Attributes:
        ...
        project (str):
            ...
            IAM policy is set on a folder or orgnization,
...
class IamPolicyAnalysisResult(proto.Message):
    ...
    class Identity(proto.Message):
        ...
        Attributes:
            name (str):
                The identity name in any form of members
                appear in [IAM policy
