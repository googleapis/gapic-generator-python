...
def test__get_api_endpoint():
    ...
    default_universe = LoggingServiceV2Client.GOOGLE_DEFAULT_UNIVERSE
    default_endpoint = LoggingServiceV2Client.DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = LoggingServiceV2Client.DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)
...
@mock.patch.object(LoggingServiceV2Client, "DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint(LoggingServiceV2Client))
@mock.patch.object(LoggingServiceV2AsyncClient, "DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint(LoggingServiceV2AsyncClient))
