...
def test__validate_universe_domain():
    ...
    client = LoggingServiceV2Client(credentials=AnonymousCredentialsWithUniverseDomain())
    ...
    client = LoggingServiceV2Client(client_options=client_options.ClientOptions(universe_domain="foo.com"), credentials=AnonymousCredentialsWithUniverseDomain())
    with pytest.raises(ValueError) as excinfo:
