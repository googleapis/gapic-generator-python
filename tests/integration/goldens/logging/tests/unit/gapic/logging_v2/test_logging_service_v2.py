...
@mock.patch.object(LoggingServiceV2Client, "DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LoggingServiceV2Client))
@mock.patch.object(LoggingServiceV2AsyncClient, "DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LoggingServiceV2AsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    universe_domain = "bar.com"
    mock_client_cert_source = mock.Mock()
    default_endpoint = LoggingServiceV2Client.DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=LoggingServiceV2Client.GOOGLE_DEFAULT_UNIVERSE)
    mock_endpoint = LoggingServiceV2Client.DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)

    assert LoggingServiceV2Client._get_api_endpoint(api_override, mock_client_cert_source, None, "always") == api_override
    assert LoggingServiceV2Client._get_api_endpoint(None, mock_client_cert_source, None, "auto") == LoggingServiceV2Client.DEFAULT_MTLS_ENDPOINT
    assert LoggingServiceV2Client._get_api_endpoint(None, None, None, "auto") == default_endpoint
    assert LoggingServiceV2Client._get_api_endpoint(None, None, None, "always") == LoggingServiceV2Client.DEFAULT_MTLS_ENDPOINT
    assert LoggingServiceV2Client._get_api_endpoint(None, mock_client_cert_source, None, "always") == LoggingServiceV2Client.DEFAULT_MTLS_ENDPOINT
    assert LoggingServiceV2Client._get_api_endpoint(None, None, universe_domain, "never") == mock_endpoint
    assert LoggingServiceV2Client._get_api_endpoint(None, None, None, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        LoggingServiceV2Client._get_api_endpoint(None, mock_client_cert_source, universe_domain, "auto")
    assert str(excinfo.value) == "MTLS is not supported in any universe other than googleapis.com."

    with pytest.raises(ValueError) as excinfo:
        LoggingServiceV2Client._get_api_endpoint(None, mock_client_cert_source, "", "auto")
...
def test__get_universe_domain():
    ...
    assert LoggingServiceV2Client._get_universe_domain(None, None) == LoggingServiceV2Client.GOOGLE_DEFAULT_UNIVERSE
