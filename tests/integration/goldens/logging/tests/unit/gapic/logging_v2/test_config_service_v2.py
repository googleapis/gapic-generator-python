...
def test_cancel_operation_rest_bad_request(transport: str = 'rest', request_type=operations_pb2.CancelOperationRequest):
    ...
    request = request_type()
    request = json_format.ParseDict({'name': 'sample1/sample2/locations/sample3/operations/sample4'}, request)
...
def test_cancel_operation_rest(request_type):
    ...
    request_init = {'name': 'sample1/sample2/locations/sample3/operations/sample4'}
    request = request_type(**request_init)
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(type(client.transport._session), 'request') as req:
        # Designate an appropriate value for the returned response.
...
def test_list_operations_rest_bad_request(transport: str = 'rest', request_type=operations_pb2.ListOperationsRequest):
    ...
    request = request_type()
    request = json_format.ParseDict({'name': 'sample1/sample2/locations/sample3'}, request)
...
def test_list_operations_rest(request_type):
    ...
    request_init = {'name': 'sample1/sample2/locations/sample3'}
    request = request_type(**request_init)
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(type(client.transport._session), 'request') as req:
        # Designate an appropriate value for the returned response.
