...
@mock.patch.object(ConfigServiceV2Client, "DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConfigServiceV2Client))
...
def test__get_api_endpoint():
    ...
    with pytest.raises(ValueError) as excinfo:
        ConfigServiceV2Client._get_api_endpoint(None, mock_client_cert_source, "", "auto")
...
def test__get_universe_domain():
    ...
    assert ConfigServiceV2Client._get_universe_domain(None, None) == ConfigServiceV2Client.GOOGLE_DEFAULT_UNIVERSE
