...
def test__get_api_endpoint():
    ...
    mock_endpoint = ConfigServiceV2Client.DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)
...
def test__validate_universe_domain():
    ...
    client = ConfigServiceV2Client(credentials=AnonymousCredentialsWithUniverseDomain())
    ...
    client = ConfigServiceV2Client(client_options=client_options.ClientOptions(universe_domain="foo.com"), credentials=AnonymousCredentialsWithUniverseDomain())
    with pytest.raises(ValueError) as excinfo:
