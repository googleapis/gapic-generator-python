...
class MetricsServiceV2RestTransport(MetricsServiceV2Transport):
    ...
    class _CancelOperation(MetricsServiceV2RestStub):
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{name=*/*/locations/*/operations/*}:cancel',
                'body': '*',
            },
{
                'method': 'post',
...
{
                'method': 'post',
                'uri': '/v2/{name=organizations/*/locations/*/operations/*}:cancel',
                'body': '*',
            },
{
                'method': 'post',
                'uri': '/v2/{name=folders/*/locations/*/operations/*}:cancel',
                'body': '*',
            },
{
                'method': 'post',
                'uri': '/v2/{name=billingAccounts/*/locations/*/operations/*}:cancel',
                'body': '*',
            },
            ]
    ...
    class _GetOperation(MetricsServiceV2RestStub):
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v2/{name=*/*/locations/*/operations/*}',
            },
{
                'method': 'get',
...
{
                'method': 'get',
                'uri': '/v2/{name=organizations/*/locations/*/operations/*}',
            },
{
                'method': 'get',
                'uri': '/v2/{name=folders/*/locations/*/operations/*}',
            },
{
                'method': 'get',
                'uri': '/v2/{name=billingAccounts/*/locations/*/operations/*}',
            },
            ]
    ...
    class _ListOperations(MetricsServiceV2RestStub):
        def __call__(self,
