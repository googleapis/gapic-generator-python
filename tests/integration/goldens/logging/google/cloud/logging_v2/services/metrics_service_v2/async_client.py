...
class MetricsServiceV2AsyncClientCallMetadata(BaseCallMetadata):
    def __init__(
            self,
...
class MetricsServiceV2AsyncClient:
    ...
    async def list_log_metrics(self,
        ...
        rpc = wrapped_methods[self._client._transport.list_log_metrics]
        ...
        if isinstance(response, tuple): # pragma: NO COVER
            ...
            if raw_response_callback:
                ...
                call_metadata = MetricsServiceV2AsyncClientCallMetadata(response_metadata = response_metadata)
    ...
    async def get_log_metric(self,
        ...
        rpc = wrapped_methods[self._client._transport.get_log_metric]
    ...
    async def create_log_metric(self,
        ...
        rpc = wrapped_methods[self._client._transport.create_log_metric]
    ...
    async def update_log_metric(self,
        ...
        rpc = wrapped_methods[self._client._transport.update_log_metric]
    ...
    async def delete_log_metric(self,
        ...
        rpc = wrapped_methods[self._client._transport.delete_log_metric]
