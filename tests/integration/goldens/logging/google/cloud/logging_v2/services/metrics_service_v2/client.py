...
class MetricsServiceV2Client(metaclass=MetricsServiceV2ClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            if universe_domain != MetricsServiceV2Client.GOOGLE_DEFAULT_UNIVERSE:
            ...
            api_endpoint = MetricsServiceV2Client.DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain, universe_domain_env):
        ...
        """
        universe_domain = MetricsServiceV2Client.GOOGLE_DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        """
        self._is_universe_domain_valid = MetricsServiceV2Client.compare_universes(self.universe_domain, self.transport._credentials.universe_domain)
    ...
    def __init__(self, *,
        ...
        self._api_endpoint = MetricsServiceV2Client._get_api_endpoint(self._client_options.api_endpoint, self._client_cert_source, self._universe_domain, self._use_mtls_endpoint)
