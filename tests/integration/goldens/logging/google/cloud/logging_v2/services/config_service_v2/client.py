...
class ConfigServiceV2Client(metaclass=ConfigServiceV2ClientMeta):
    ...
    def _get_universe_domain(client_universe_domain, universe_domain_env):
        ...
        """
        universe_domain = ConfigServiceV2Client.GOOGLE_DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        """
        self._is_universe_domain_valid = ConfigServiceV2Client.compare_universes(self.universe_domain, self.transport._credentials.universe_domain)
    ...
    def __init__(self, *,
        ...
        self._api_endpoint = ConfigServiceV2Client._get_api_endpoint(self._client_options.api_endpoint, self._client_cert_source, self._universe_domain, self._use_mtls_endpoint)
