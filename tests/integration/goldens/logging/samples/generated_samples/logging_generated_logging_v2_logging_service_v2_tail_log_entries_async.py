...
# [START logging_generated_logging_v2_LoggingServiceV2_TailLogEntries_async]
...
async def sample_tail_log_entries():
    ...
    # Here we have create a generator that yields a single `request` for
...
# [END logging_generated_logging_v2_LoggingServiceV2_TailLogEntries_async]
