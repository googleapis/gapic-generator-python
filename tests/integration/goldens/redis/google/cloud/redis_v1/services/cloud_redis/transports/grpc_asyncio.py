...
class CloudRedisGrpcAsyncIOTransport(CloudRedisTransport):
    ...
    def get_instance_auth_string(
        self,
    ) -> Callable[[cloud_redis.GetInstanceAuthStringRequest], Awaitable[cloud_redis.InstanceAuthString]]:
    ...
    def upgrade_instance(
        self,
    ) -> Callable[[cloud_redis.UpgradeInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def import_instance(
        self,
    ) -> Callable[[cloud_redis.ImportInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def export_instance(
        self,
    ) -> Callable[[cloud_redis.ExportInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def failover_instance(
        self,
    ) -> Callable[[cloud_redis.FailoverInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def reschedule_maintenance(
        self,
    ) -> Callable[[cloud_redis.RescheduleMaintenanceRequest], Awaitable[operations_pb2.Operation]]:
