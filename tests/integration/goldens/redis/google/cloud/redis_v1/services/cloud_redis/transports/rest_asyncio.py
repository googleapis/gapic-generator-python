...
class CloudRedisRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the CloudRedisRestAsyncioTransport.
    ...
    .. code-block:: python
        ...
        transport = CloudRedisRestAsyncioTransport(interceptor=MyCustomCloudRedisInterceptor())
...
class CloudRedisRestAsyncioTransport(CloudRedisTransport):
...
__all__=(
    'CloudRedisRestAsyncioTransport',
)
