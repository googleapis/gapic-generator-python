    ...
    def build(
        *file_descriptors: descriptor_pb2.FileDescriptorProto,
        ...
        if opts.api_description:
            package_info = dataclasses.replace(package_info, api_description=opts.api_description)

        if opts.documentation_uri:
            package_info = dataclasses.replace(package_info, documentation_uri=opts.documentation_uri)
