...
class Generator:
    ...
    def _render_template(
        ...
        *,
        ...
        # Don't generate `docs/summary_overview.md` for non-cloud APIs
        if template_name == "docs/summary_overview.md.j2" and (api_schema.naming.module_namespace[0] != "google" or api_schema.naming.module_namespace[1] != "cloud"):
            return answer
